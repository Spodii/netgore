...
namespace MySql.Data.MySqlClient.Tests
{
    ...
    public class PreparedStatements : BaseTest
    {
        ...
        void NegativeTime(bool prepared)
        {
            execSQL("DROP TABLE IF EXISTS Test");
            ...
            var times = new TimeSpan[8]
                        {
                            new TimeSpan(-10, 0, 0), new TimeSpan(2, -5, 10, 20), new TimeSpan(20, -10, 10),
                            new TimeSpan(0, -15, 25), new TimeSpan(-4, -10, 20, -10), new TimeSpan(3, 17, 23, 6),
        ...
        void ReadNegativeTime(bool prepared)
        {
            execSQL("DROP TABLE IF EXISTS Test");
            execSQL("CREATE TABLE Test(id int, t time)");
        ...
        public void Blobs()
        {
            ...
            var bytes = Utils.CreateBlob(400000);
        ...
        public void Bug6271()
        {
            ...
            var xpDOSG_Avatar = Utils.CreateBlob(13000);
        ...
        public void ClosingCommandsProperly()
        {
            ...
            string connStr = GetConnectionString(true) + ";ignore prepare=false";
            using (MySqlConnection c = new MySqlConnection(connStr))
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    using (MySqlCommand cmd = new MySqlCommand("INSERT INTO Test VALUES (?id, ?name)", c))
                    {
        ...
        {
            execSQL("DROP TABLE IF EXISTS Test");
            execSQL("CREATE TABLE IF NOT EXISTS Test (" + "id INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT," +
                    "test1 INT UNSIGNED, test2 INT UNSIGNED)");

            try
            {
                MySqlCommand cmd = conn.CreateCommand();
                cmd.CommandText = "INSERT INTO Test VALUES (NULL, ?t1, ?t2);" + "SELECT last_insert_id()";
        ...
        {
            execSQL("DROP TABLE IF EXISTS Test");
            execSQL("CREATE TABLE Test (id int NOT NULL AUTO_INCREMENT, " + "id2 int NOT NULL, name varchar(50) DEFAULT NULL, " +
                    "id3 int DEFAULT NULL, PRIMARY KEY (id))");

            MySqlCommand cmd = new MySqlCommand("INSERT INTO Test (id, id2, name, id3) " + "VALUES(?id, ?id2, ?name,?id3)", conn);
        ...
        public void InsertAccentedCharacters()
        {
            ...
            // COLLATE " +
            //"utf8_bin");
            MySqlConnection conn2 = new MySqlConnection(GetConnectionString(true) + ";charset=utf8");
            try
            {
                conn2.Open();
                ...
                MySqlCommand cmd =
                    new MySqlCommand(
                        "INSERT INTO Test(input) " + "VALUES (?input) ON DUPLICATE KEY UPDATE " + "id=LAST_INSERT_ID(id)", conn2);
                ...
                Assert.AreEqual("irache martínez@yahoo.es aol.com", cmd2.ExecuteScalar());
            }
            catch (Exception ex)
            {
                Assert.Fail(ex.Message);
        ...
        public void InsertingUnsignedTinyInt()
        {
            execSQL("DROP TABLE IF EXISTS Test");
            execSQL(
                @"CREATE TABLE Test(id TINYINT UNSIGNED NOT NULL, 
        ...
        public void MoreParametersOutOfOrder()
        {
            ...
            execSQL("CREATE TABLE `Test` (`BlackListID` int(11) NOT NULL auto_increment, " +
                    "`SubscriberID` int(11) NOT NULL, `Phone` varchar(50) default NULL, " + "`ContactID` int(11) default NULL, " +
        ...
        public void SimpleTest2()
        {
            execSQL("DROP TABLE IF EXISTS Test");
            execSQL(
                "CREATE TABLE Test (one integer, two integer, three integer, four integer, five integer, six integer, seven integer)");
        ...
        public void UnsignedTinyInt()
        {
            ...
            execSQL("CREATE TABLE Test(ID TINYINT UNSIGNED NOT NULL, " +
                    "Name VARCHAR(50) NOT NULL,	PRIMARY KEY (ID), UNIQUE (ID), " + "UNIQUE (Name))");
        ...
        public void UnsignedValues()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("INSERT INTO Test VALUES (?ulVal, " + "?lVal, ?mVal, ?sVal)", conn);
        ...
        public void UsingParametersTwice()
        {
            ...
            MySqlCommand cmd =
                new MySqlCommand(
                    "Insert into Test (input, " + "state, score) VALUES (?input, ?st, ?sc) ON DUPLICATE KEY " +
