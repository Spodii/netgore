...
namespace MySql.Data.MySqlClient.Tests
{
    ...
    public class ParameterTests : BaseTest
    {
        ...
        {
            MySqlCommand cmd = new MySqlCommand("Insert into sometable(s1, s2) values(?p1, ?p2)");
        ...
        {
            MySqlParameter p = new MySqlParameter("?p1", MySqlDbType.VarChar, 20, ParameterDirection.InputOutput, true, 0, 0, "id",
                                                  DataRowVersion.Current, 0);
            Assert.AreEqual(ParameterDirection.InputOutput, p.Direction);

            MySqlParameter p1 = new MySqlParameter("?p1", MySqlDbType.VarChar, 20, ParameterDirection.Output, true, 0, 0, "id",
                                                   DataRowVersion.Current, 0);
