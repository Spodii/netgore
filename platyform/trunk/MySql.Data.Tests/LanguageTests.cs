...
namespace MySql.Data.MySqlClient.Tests
{
    ...
    public class LanguageTests : BaseTest
    {
        ...
        {
            execSQL("DROP TABLE IF EXISTS test");
            execSQL("CREATE TABLE test (id int(11) NOT NULL, " + "value varchar(100) NOT NULL, PRIMARY KEY (id)) " +
        ...
        public void VariousCollations()
        {
            ...
            execSQL(
                "CREATE TABLE `test_tbl` ( `test` VARCHAR( 255 ) NOT NULL) CHARACTER SET utf8 COLLATE utf8_swedish_ci TYPE = MYISAM");
