...
namespace DemoGame.Server.Queries
{
    ...
    public class InsertWorldStatsUserLevelQuery : DbQueryNonReader<IWorldStatsUserLevelTable>
    {
        ...
        static string CreateQuery(IQueryBuilder qb)
        {
            ...
            var q = qb.Insert(WorldStatsUserLevelTable.TableName).AddAutoParam(WorldStatsUserLevelTable.DbColumns);
            return q.ToString();
        }
        ...
        {
            return CreateParameters(WorldStatsUserLevelTable.DbColumns);
        }
