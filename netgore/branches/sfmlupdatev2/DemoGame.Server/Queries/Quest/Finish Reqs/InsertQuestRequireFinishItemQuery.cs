...
{
    [DbControllerQuery]
    public class InsertQuestRequireFinishItemQuery : DbQueryNonReader<IQuestRequireFinishItemTable>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InsertQuestRequireFinishItemQuery"/> class.
        /// </summary>
        /// <param name="connectionPool"><see cref="DbConnectionPool"/> to use for creating connections to
        /// execute the query on.</param>
        public InsertQuestRequireFinishItemQuery(DbConnectionPool connectionPool)
        ...
        {
            Execute(new QuestRequireFinishItemTable(amount, itemID, questID));
        }
