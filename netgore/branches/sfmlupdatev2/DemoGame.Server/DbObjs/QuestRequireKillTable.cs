...
namespace DemoGame.Server.DbObjs
{
    ...
    public class QuestRequireKillTable : IQuestRequireKillTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "amount":
                    return new ColumnMetadata("amount", "The number of characters that must be killed to complete this quest.",
                        "smallint(5) unsigned", null, typeof(UInt16), false, false, false);

                case "character_template_id":
                    return new ColumnMetadata("character_template_id",
                        "The template of the characters that must be killed to complete this quest.", "smallint(5) unsigned", null,
