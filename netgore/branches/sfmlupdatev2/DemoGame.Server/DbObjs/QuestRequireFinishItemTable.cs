...
namespace DemoGame.Server.DbObjs
{
    ...
    public class QuestRequireFinishItemTable : IQuestRequireFinishItemTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "amount":
                    return new ColumnMetadata("amount", "The amount of the item required to finish this quest.",
                        "tinyint(3) unsigned", null, typeof(Byte), false, false, false);

                case "item_template_id":
                    return new ColumnMetadata("item_template_id",
                        "The template of the item that is required for this quest to be finished.", "smallint(5) unsigned", null,
