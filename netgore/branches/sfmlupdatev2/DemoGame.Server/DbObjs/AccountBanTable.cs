    ...
    public class AccountBanTable : IAccountBanTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "id":
                    return new ColumnMetadata("id", "The unique ID.", "int(11)", null, typeof(Int32), false, true, false);

                case "issued_by":
                    return new ColumnMetadata("issued_by",
                        "Name of the person or system that issued this ban (not strongly typed at all).", "varchar(255)", null,
