...
namespace DemoGame.Server.DbObjs
{
    ...
    /// </summary>
    public class WorldStatsCountShopSellTable : IWorldStatsCountShopSellTable, IPersistable
    {
        /// <summary>
        ...
        /// </summary>
        public const String TableName = "world_stats_count_shop_sell";
        ...
        public static void CopyValues(IWorldStatsCountShopSellTable source, IDictionary<String, Object> dic)
        {
            ...
            switch (columnName)
            {
                case "count":
                    return new ColumnMetadata("count",
                        "The number of times this shop has purchased items (shopper has sold to this shop).", "int(11)", "0",
        ...
        #region IWorldStatsCountShopSellTable Members
