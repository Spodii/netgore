...
namespace DemoGame.Server.DbObjs
{
    ...
    /// </summary>
    public class ViewNpcCharacterTable : IViewNpcCharacterTable, IPersistable
    {
        /// <summary>
        ...
        /// </summary>
        public const String TableName = "view_npc_character";
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "id":
                    return new ColumnMetadata("id", "The unique ID of the character.", "int(11)", "0", typeof(Int32), false, false,
                        false);
                ...
                case "load_map_id":
                    return new ColumnMetadata("load_map_id", "The map to load on (when logging in / being created).",
                        "smallint(5) unsigned", "3", typeof(UInt16), false, false, false);
                ...
                case "respawn_map_id":
                    return new ColumnMetadata("respawn_map_id",
                        ...
                        "smallint(5) unsigned", "3", typeof(ushort?), true, false, false);
        ...
        #region IViewNpcCharacterTable Members
