...
namespace DemoGame.Server.DbObjs
{
    ...
    public class ActiveTradeItemTable : IActiveTradeItemTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "character_id":
                    return new ColumnMetadata("character_id", "The character that added the item.", "int(11)", null, typeof(Int32),
                        false, false, true);

                case "item_id":
                    return new ColumnMetadata("item_id", "The ID of the item the character put down.", "int(11)", null,
        ...
        /// </summary>
        [Description("The ID of the item the character put down.")]
        [SyncValue]
