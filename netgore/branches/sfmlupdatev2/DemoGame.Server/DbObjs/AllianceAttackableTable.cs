...
namespace DemoGame.Server.DbObjs
{
    ...
    public class AllianceAttackableTable : IAllianceAttackableTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "alliance_id":
                    return new ColumnMetadata("alliance_id", "The alliance.", "tinyint(3) unsigned", null, typeof(Byte), false,
                        true, false);

                case "attackable_id":
                    return new ColumnMetadata("attackable_id", "The alliance that this alliance (alliance_id) can attack.",
        ...
        /// </summary>
        [Description("The alliance that this alliance (alliance_id) can attack.")]
        [SyncValue]
