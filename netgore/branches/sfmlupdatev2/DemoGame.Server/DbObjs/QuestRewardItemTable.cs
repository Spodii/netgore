...
namespace DemoGame.Server.DbObjs
{
    ...
    public class QuestRewardItemTable : IQuestRewardItemTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "amount":
                    return new ColumnMetadata("amount", "The amount of the item to give (should be greater than 0).",
                        "tinyint(3) unsigned", null, typeof(Byte), false, false, false);

                case "item_template_id":
                    return new ColumnMetadata("item_template_id", "The template of the item to give as the reward.",
                        "smallint(5) unsigned", null, typeof(UInt16), false, true, false);

                case "quest_id":
                    return new ColumnMetadata("quest_id", "The quest that this completion reward is for.", "smallint(5) unsigned",
