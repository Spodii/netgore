...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterQuestStatusTable : ICharacterQuestStatusTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "character_id":
                    return new ColumnMetadata("character_id", "Character this quest status info is for.", "int(11)", null,
                        typeof(Int32), false, true, false);

                case "completed_on":
                    return new ColumnMetadata("completed_on",
                        "When the quest was completed. Null if incomplete. Repeatable quests hold time is was most recently completed.",
                        "datetime", null, typeof(DateTime?), true, false, false);

                case "quest_id":
                    return new ColumnMetadata("quest_id", "The quest this information is for.", "smallint(5) unsigned", null,
                        typeof(UInt16), false, true, false);

                case "started_on":
                    return new ColumnMetadata("started_on", "When the quest was started.", "datetime", null, typeof(DateTime),
                        false, false, false);
