...
namespace DemoGame.Server.DbObjs
{
    ...
    /// </summary>
    public class WorldStatsCountConsumeItemTable : IWorldStatsCountConsumeItemTable, IPersistable
    {
        /// <summary>
        ...
        /// </summary>
        public const String TableName = "world_stats_count_consume_item";
        ...
        public static void CopyValues(IWorldStatsCountConsumeItemTable source, IDictionary<String, Object> dic)
        {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "count":
                    return new ColumnMetadata("count", "Number of times items of this template have been consumed.", "int(11)",
                        "0", typeof(Int32), false, false, false);

                case "item_template_id":
                    return new ColumnMetadata("item_template_id", "The item template the counter is for.", "smallint(5) unsigned",
        ...
        #region IWorldStatsCountConsumeItemTable Members
