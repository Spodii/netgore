...
namespace DemoGame.Server.DbObjs
{
    ...
    public class ShopTable : IShopTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "can_buy":
                    return new ColumnMetadata("can_buy",
                        "Whether or not this shop can buy items from shoppers. When false, the shop only sells items (users cannot sell to it).",
                        "tinyint(1)", null, typeof(Boolean), false, false, false);

                case "id":
                    return new ColumnMetadata("id", "The unique ID of the shop.", "smallint(5) unsigned", null, typeof(UInt16),
                        false, true, false);

                case "name":
                    return new ColumnMetadata("name", "The name of this shop.", "varchar(60)", null, typeof(String), false, false,
                        false);
        ...
        /// </summary>
        [Description("The name of this shop.")]
        [SyncValue]
        public String Name
        {
            get { return _name; }
