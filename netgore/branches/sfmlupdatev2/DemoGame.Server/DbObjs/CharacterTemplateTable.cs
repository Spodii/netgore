...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTemplateTable : ICharacterTemplateTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "ai_id":
                    return new ColumnMetadata("ai_id", "The AI (intended for NPCs only).", "smallint(5) unsigned", null,
                        typeof(ushort?), true, false, false);

                case "alliance_id":
                    return new ColumnMetadata("alliance_id", "The alliance.", "tinyint(3) unsigned", "0", typeof(Byte), false,
                        false, true);

                case "body_id":
                    return new ColumnMetadata("body_id", "The body to use.", "smallint(5) unsigned", "1", typeof(UInt16), false,
                        false, false);

                case "chat_dialog":
                    return new ColumnMetadata("chat_dialog", "The chat dialog (intended for NPCs only).", "smallint(5) unsigned",
                        null, typeof(ushort?), true, false, false);

                case "exp":
                    return new ColumnMetadata("exp", "Current exp.", "int(11)", "0", typeof(Int32), false, false, false);

                case "give_cash":
                    return new ColumnMetadata("give_cash", "Amount of cash to give when killed (intended for NPCs only).",
                        "smallint(5) unsigned", "0", typeof(UInt16), false, false, false);

                case "give_exp":
                    return new ColumnMetadata("give_exp", "Amount of exp to give when killed (intended for NPCs only).",
                        "smallint(5) unsigned", "0", typeof(UInt16), false, false, false);

                case "id":
                    return new ColumnMetadata("id", "The unique ID of the character template.", "smallint(5) unsigned", null,
                        typeof(UInt16), false, true, false);

                case "level":
                    return new ColumnMetadata("level", "The character's level.", "tinyint(3) unsigned", "1", typeof(Byte), false,
                        false, false);

                case "move_speed":
                    return new ColumnMetadata("move_speed", "The movement speed.", "smallint(5) unsigned", "1800", typeof(UInt16),
                        false, false, false);
                ...
                case "name":
                    return new ColumnMetadata("name",
                        ...
                        "varchar(50)", "New NPC", typeof(String), false, false, false);

                case "respawn":
                    return new ColumnMetadata("respawn", "How long to wait after death to be respawned (intended for NPCs only).",
                        "smallint(5) unsigned", "5", typeof(UInt16), false, false, false);

                case "shop_id":
                    return new ColumnMetadata("shop_id", "The shop (intended for NPCs only).", "smallint(5) unsigned", null,
                        typeof(ushort?), true, false, true);

                case "statpoints":
                    return new ColumnMetadata("statpoints", "Number of stat points available to spend.", "int(11)", "0",
        ...
        /// </summary>
        [Description("The unique ID of the character template.")]
        [SyncValue]
        ...
        /// </summary>
        [Description("How long to wait after death to be respawned (intended for NPCs only).")]
        [SyncValue]
