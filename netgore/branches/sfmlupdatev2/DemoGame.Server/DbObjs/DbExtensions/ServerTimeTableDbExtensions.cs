...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class ServerTimeTableDbExtensions
    {
        ...
        public static void ReadValues(this ServerTimeTable source, IDataRecord dataRecord)
        {
            Int32 i;

            i = dataRecord.GetOrdinal("server_time");

            source.ServerTime = dataRecord.GetDateTime(i);
        }
        ...
        public static void TryReadValues(this ServerTimeTable source, IDataRecord dataRecord)
        {
