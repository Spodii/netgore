...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AllianceTableDbExtensions
    {
        ...
        public static void ReadValues(this AllianceTable source, IDataRecord dataRecord)
        {
            Int32 i;

            i = dataRecord.GetOrdinal("id");

            source.ID = (AllianceID)dataRecord.GetByte(i);
        ...
        public static void TryReadValues(this AllianceTable source, IDataRecord dataRecord)
        {
