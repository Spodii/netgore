...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class ActiveTradeItemTableDbExtensions
    {
        ...
        public static void ReadValues(this ActiveTradeItemTable source, IDataRecord dataRecord)
        {
            Int32 i;
        ...
        public static void TryReadValues(this ActiveTradeItemTable source, IDataRecord dataRecord)
        {
