...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterStatusEffectTableDbExtensions
    {
        ...
        public static void ReadValues(this CharacterStatusEffectTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.ID = (ActiveStatusEffectID)dataRecord.GetInt32(i);

            i = dataRecord.GetOrdinal("power");

            source.Power = dataRecord.GetUInt16(i);

            i = dataRecord.GetOrdinal("status_effect_id");

            source.StatusEffect = (StatusEffectType)dataRecord.GetByte(i);

            i = dataRecord.GetOrdinal("time_left_secs");

            source.TimeLeftSecs = dataRecord.GetUInt16(i);
        }
        ...
        public static void TryReadValues(this CharacterStatusEffectTable source, IDataRecord dataRecord)
        {
