...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class QuestRewardItemTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IQuestRewardItemTable source, IQuestRewardItemTable otherItem)
        {
        ...
        public static void ReadValues(this QuestRewardItemTable source, IDataRecord dataRecord)
        {
            Int32 i;
        ...
        public static void TryReadValues(this QuestRewardItemTable source, IDataRecord dataRecord)
        {
