...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterTemplateTableDbExtensions
    {
        ...
        public static void ReadValues(this CharacterTemplateTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.AllianceID = (AllianceID)dataRecord.GetByte(i);
            ...
            source.GiveCash = dataRecord.GetUInt16(i);

            i = dataRecord.GetOrdinal("give_exp");

            source.GiveExp = dataRecord.GetUInt16(i);

            i = dataRecord.GetOrdinal("id");

            source.ID = (CharacterTemplateID)dataRecord.GetUInt16(i);
            ...
            source.Respawn = dataRecord.GetUInt16(i);
        ...
        public static void TryReadValues(this CharacterTemplateTable source, IDataRecord dataRecord)
        {
