...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class QuestTableDbExtensions
    {
        ...
        public static void ReadValues(this QuestTable source, IDataRecord dataRecord)
        {
            Int32 i;

            i = dataRecord.GetOrdinal("id");

            source.ID = (QuestID)dataRecord.GetUInt16(i);

            i = dataRecord.GetOrdinal("repeatable");

            source.Repeatable = dataRecord.GetBoolean(i);

            i = dataRecord.GetOrdinal("reward_cash");

            source.RewardCash = dataRecord.GetInt32(i);

            i = dataRecord.GetOrdinal("reward_exp");

            source.RewardExp = dataRecord.GetInt32(i);
        }
        ...
        public static void TryReadValues(this QuestTable source, IDataRecord dataRecord)
        {
