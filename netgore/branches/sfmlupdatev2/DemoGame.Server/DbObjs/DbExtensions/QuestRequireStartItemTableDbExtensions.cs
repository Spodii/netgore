...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class QuestRequireStartItemTableDbExtensions
    {
        ...
        public static void ReadValues(this QuestRequireStartItemTable source, IDataRecord dataRecord)
        {
            Int32 i;
        ...
        public static void TryReadValues(this QuestRequireStartItemTable source, IDataRecord dataRecord)
        {
