...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AccountCharacterTableDbExtensions
    {
        ...
        public static void ReadValues(this AccountCharacterTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.TimeDeleted = (dataRecord.IsDBNull(i) ? (DateTime?)null : dataRecord.GetDateTime(i));
        }
        ...
        public static void TryReadValues(this AccountCharacterTable source, IDataRecord dataRecord)
        {
