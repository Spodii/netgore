...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class GuildMemberTableDbExtensions
    {
        ...
        public static void ReadValues(this GuildMemberTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.Joined = dataRecord.GetDateTime(i);

            i = dataRecord.GetOrdinal("rank");

            source.Rank = dataRecord.GetByte(i);
        }
        ...
        public static void TryReadValues(this GuildMemberTable source, IDataRecord dataRecord)
        {
