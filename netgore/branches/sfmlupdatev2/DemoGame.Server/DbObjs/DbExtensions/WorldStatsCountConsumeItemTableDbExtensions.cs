...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class WorldStatsCountConsumeItemTableDbExtensions
    {
        ...
        public static void ReadValues(this WorldStatsCountConsumeItemTable source, IDataRecord dataRecord)
        {
            Int32 i;
        ...
        public static void TryReadValues(this WorldStatsCountConsumeItemTable source, IDataRecord dataRecord)
        {
