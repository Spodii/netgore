...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterInventoryTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this ICharacterInventoryTable source, ICharacterInventoryTable otherItem)
        {
        ...
        public static void ReadValues(this CharacterInventoryTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.ItemID = (ItemID)dataRecord.GetInt32(i);

            i = dataRecord.GetOrdinal("slot");

            source.Slot = (InventorySlot)dataRecord.GetByte(i);
        }
        ...
        public static void TryReadValues(this CharacterInventoryTable source, IDataRecord dataRecord)
        {
