...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterEquippedTableDbExtensions
    {
        ...
        public static void ReadValues(this CharacterEquippedTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.Slot = (EquipmentSlot)dataRecord.GetByte(i);
        }
        ...
        public static void TryReadValues(this CharacterEquippedTable source, IDataRecord dataRecord)
        {
