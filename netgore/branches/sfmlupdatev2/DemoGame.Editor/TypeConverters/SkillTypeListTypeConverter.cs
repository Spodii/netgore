...
{
    /// <summary>
    /// A <see cref="TypeConverter"/> for a collection of <see cref="SkillType"/>s and values.
    /// </summary>
    public class SkillTypeListTypeConverter : TypeConverter
    {
        /// <summary>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                var ev = value as IEnumerable<SkillType>;
                if (ev != null)
                {
