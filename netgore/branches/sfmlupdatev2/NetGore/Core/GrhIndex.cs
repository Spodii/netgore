...
namespace NetGore
{
    ...
    public struct GrhIndex : IComparable<GrhIndex>, IConvertible, IFormattable, IComparable<int>, IEquatable<int>
    {
        ...
        /// <summary>
        /// Reads an GrhIndex from an <see cref="IDataRecord"/>.
        /// </summary>
        ...
        public static GrhIndex Read(IDataRecord reader, int i)
        {
        ...
        /// <returns>The GrhIndex read from the <see cref="IDataRecord"/>.</returns>
        public static GrhIndex Read(IDataRecord reader, string name)
        {
        ...
        #region IComparable<GrhIndex> Members
        ...
        /// </returns>
        public int CompareTo(GrhIndex other)
        {
