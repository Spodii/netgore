    ...
    public sealed class XmlConfigurator
    {
        ...
        public static void Configure(ILoggerRepository repository)
        {
            ...
            try
            {
                ...
                configElement = ConfigurationManager.GetSection("log4net") as XmlElement;
            ...
            catch (ConfigurationException confEx)
            {
                ...
                else
                {
                    ...
                    var configSectionStr = "<section name=\"log4net\" type=\"log4net.Config.Log4NetConfigurationSectionHandler," +
                                           Assembly.GetExecutingAssembly().FullName + "\" />";
                    LogLog.Error(
                        "XmlConfigurator: Failed to parse config file. Is the <configSections> specified as: " + configSectionStr,
                        confEx);
                }
            }
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (configRequest != null)
                    {
                        ...
                        try
                        {
                            var response = configRequest.GetResponse();
                            if (response != null)
                            {
                                try
                                {
        ...
        public static void Configure(ILoggerRepository repository, Stream configStream)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    var xmlReader = XmlReader.Create(configStream, settings);
        ...
        public static void ConfigureAndWatch(ILoggerRepository repository, FileInfo configFile)
        {
            ...
            else
            {
                ...
                {
                    LogLog.Error(
                        "XmlConfigurator: Failed to initialize configuration file watcher for file [" + configFile.FullName + "]",
                        ex);
                }
            }
        }
