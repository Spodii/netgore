...
namespace log4net
{
    ...
    public sealed class LogManager
    {
        ...
        static ILog WrapLogger(ILogger logger)
        {
        ...
        /// <returns>The wrapper for the logger specified.</returns>
        static ILoggerWrapper WrapperCreationHandler(ILogger logger)
        {
        ...
        /// </summary>
        static readonly WrapperMap s_wrapperMap = new WrapperMap(WrapperCreationHandler);
