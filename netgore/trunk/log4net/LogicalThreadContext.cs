...
namespace log4net
{
    ...
    public sealed class LogicalThreadContext
    {
        ...
        /// </summary>
        static readonly LogicalThreadContextProperties s_properties = new LogicalThreadContextProperties();

        /// <summary>
        /// The thread context stacks instance
        /// </summary>
        static readonly ThreadContextStacks s_stacks = new ThreadContextStacks(s_properties);
