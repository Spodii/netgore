...
namespace log4net.Layout
{
    ...
    public class XmlLayout : XmlLayoutBase
    {
        ...
        bool m_base64Message = false;
        bool m_base64Properties = false;
        string m_elmData = ELM_DATA;
        string m_elmEvent = ELM_EVENT;
        string m_elmException = ELM_EXCEPTION;
        string m_elmLocation = ELM_LOCATION;
        string m_elmMessage = ELM_MESSAGE;
        string m_elmProperties = ELM_PROPERTIES;
