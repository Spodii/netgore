...
namespace log4net.Layout
{
    ...
    public abstract class XmlLayoutBase : LayoutSkeleton
    {
        ...
        public override void Format(TextWriter writer, LoggingEvent loggingEvent)
        {
            ...
            var xmlWriter = new XmlTextWriter(m_protectCloseTextWriter);
        ...
        /// </summary>
        readonly ProtectCloseTextWriter m_protectCloseTextWriter = new ProtectCloseTextWriter(null);

        /// <summary>
        /// The string to replace invalid chars with
        /// </summary>
        string m_invalidCharReplacement = "?";
