...
namespace log4net.Plugin
{
    ...
    /// <remarks>
    /// <para>
    /// This plugin publishes an instance of <see cref="RemotingAppender.IRemoteLoggingSink"/> 
    ...
    public class RemoteLoggingServerPlugin : PluginSkeleton
    {
        ...
        /// </para>
        /// </remarks>
        class RemoteLoggingSinkImpl : MarshalByRefObject, RemotingAppender.IRemoteLoggingSink
        {
            #region Public Instance Constructors
