    ...
    public abstract class BufferingAppenderSkeleton : AppenderSkeleton
    {
                    ...
                    if (m_lossy)
                    {
                        ...
                        if (flushLossyBuffer)
                        {
                            if (m_lossyEvaluator != null)
                            {
                                ...
                                var bufferedEvents = m_cb.PopAll();
                                var filteredEvents = new ArrayList(bufferedEvents.Length);

                                foreach (var loggingEvent in bufferedEvents)
                                {
        ...
        protected override void Append(LoggingEvent loggingEvent)
        {
            ...
            if (m_cb == null || m_bufferSize <= 1)
            {
                ...
                if ((!m_lossy) || (m_evaluator != null && m_evaluator.IsTriggeringEvent(loggingEvent)) ||
            ...
            else
            {
                ...
                var discardedLoggingEvent = m_cb.Append(loggingEvent);
        ...
        {
            var bufferEvents = buffer.PopAll();
        ...
        /// </remarks>
        ITriggeringEventEvaluator m_evaluator;
        ...
        /// </remarks>
        FixFlags m_fixFlags = FixFlags.All;
        ...
        /// be discarded. 
        /// </remarks>
        ITriggeringEventEvaluator m_lossyEvaluator;
