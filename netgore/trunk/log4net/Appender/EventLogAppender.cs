...
namespace log4net.Appender
{
    ...
    public class EventLogAppender : AppenderSkeleton
    {
        ...
        public string MachineName
        {
            ...
            set
            {
                /* Currently we do not allow the machine name to be changed */
                ;
            }
        }
        ...
        public override void ActivateOptions()
        {
            ...
            {
                LogLog.Debug("EventLogAppender: Changing event source [" + m_applicationName + "] from log [" + currentLogName +
                             "] to log [" + m_logName + "]");
            }
        ...
        protected virtual EventLogEntryType GetEntryType(Level level)
        {
            ...
            var entryType = m_levelMapping.Lookup(level) as Level2EventLogEntryType;
            if (entryType != null)
