...
namespace log4net.Appender
{
    ...
    public class AppenderCollection : ICollection, IList, IEnumerable, ICloneable
    {
        ...
        sealed class Enumerator : IEnumerator, IAppenderCollectionEnumerator
        {
            ...
            #region IAppenderCollectionEnumerator Members
        ...
        /// <exclude/>
        sealed class ReadOnlyAppenderCollection : AppenderCollection, ICollection
        {
            #region Implementation (data)
