...
namespace GoreUpdater.Manager
{
    ...
    public static class HelpHelper
    {
        ...
        static HelpHelper()
        {
            _serverType = new HelpMessage("Server type", "The method to use to communicate with the server. This is the method used by the update manager only," +
            ...
            _host = new HelpMessage("Host", "The fully qualified address of the server, including the protocol and the sub-directory to use."
                + " For example, for ftp:" + Environment.NewLine +
                "   ftp://www.mydomain.com/subdirectory/");

            _createNewVersion = new HelpMessage("Create new version", "Creates the next version, which by default is always the version immediately after the live version."
            ...
            _liveVersion = new HelpMessage("Live version", "The live version is the current version that clients are updated to. It is usually either the latest version," +
                " or the version immediately before the latest version.");

            _changeLiveVersion = new HelpMessage("Change live version", "This will set the live version to the next version, as long as the next version is available."
        ...
        /// </summary>
        public static HelpMessage HelpChangeLiveVersion { get { return _changeLiveVersion; } }

        /// <summary>
        /// Gets the <see cref="HelpMessage"/> for the live version.
        /// </summary>
        public static HelpMessage HelpLiveVersion { get { return _liveVersion; } }

        /// <summary>
        /// Gets the <see cref="HelpMessage"/> for creating a new version.
        /// </summary>
        public static HelpMessage HelpCreateNewVersion { get { return _createNewVersion; } }

        /// <summary>
        /// Gets the <see cref="HelpMessage"/> for the server type.
        /// </summary>
        public static HelpMessage HelpServerType { get { return _serverType; } }

        /// <summary>
        /// Gets the <see cref="HelpMessage"/> for the host.
        /// </summary>
        public static HelpMessage HelpHost { get { return _host; } }

        /// <summary>
        /// Gets the <see cref="HelpMessage"/> for the account user.
        /// </summary>
        public static HelpMessage HelpAccountUser { get { return _accountUser; } }

        /// <summary>
        /// Gets the <see cref="HelpMessage"/> for the account password.
        /// </summary>
        public static HelpMessage HelpAccountPassword { get { return _accountPassword; } }
