...
namespace NetGore.Collections
{
    ...
    public class ThreadSafeHashFactory<TKey, TValue> : IFactory<TKey, TValue> where TValue : class
    {
        ...
        public ThreadSafeHashFactory(Func<TKey, TValue> valueCreator) : this(valueCreator, null)
        {
        }
