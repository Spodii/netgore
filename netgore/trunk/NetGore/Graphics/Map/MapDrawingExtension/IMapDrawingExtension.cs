...
namespace NetGore.Graphics
{
    ...
    public interface IMapDrawingExtension
    {
        ...
        void DrawAfterLayer(IDrawableMap map, MapRenderLayer layer, ISpriteBatch spriteBatch);
        ...
        /// <param name="spriteBatch">The <see cref="ISpriteBatch"/> to draw to.</param>
        void DrawBeforeLayer(IDrawableMap map, MapRenderLayer layer, ISpriteBatch spriteBatch);
    }
}