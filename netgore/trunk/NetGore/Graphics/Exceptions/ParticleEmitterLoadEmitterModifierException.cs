...
namespace NetGore.Graphics.ParticleEngine
{
    ...
    public sealed class ParticleEmitterLoadEmitterModifierException : ParticleEmitterException
    {
        ...
        ParticleEmitterLoadEmitterModifierException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
        ...
        public ParticleEmitterLoadEmitterModifierException(string message)
            : base(message)
        {
        }
