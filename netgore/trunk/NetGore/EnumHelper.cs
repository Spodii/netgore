...
namespace NetGore
{
    ...
    public static class EnumHelper
    {
        ...
        public static bool IsDefined<T>(T value) where T : struct, IComparable, IConvertible, IFormattable
        {
            if (!typeof(T).IsEnum)
                throw CreateGenericTypeIsNotEnumException<T>();
        ...
        public static T Parse<T>(string value) where T : struct, IComparable, IConvertible, IFormattable
        {
            if (!typeof(T).IsEnum)
                throw CreateGenericTypeIsNotEnumException<T>();
        ...
        /// <returns>The enum value parsed from <paramref name="value"/>.</returns>
        public static T Parse<T>(string value, bool ignoreCase) where T : struct, IComparable, IConvertible, IFormattable
        {
            if (!typeof(T).IsEnum)
                throw CreateGenericTypeIsNotEnumException<T>();
        ...
        /// <returns>The enum value parsed from <paramref name="value"/>.</returns>
        public static bool TryParse<T>(string value, out T outValue) where T : struct, IComparable, IConvertible, IFormattable
        {
            if (!typeof(T).IsEnum)
                throw CreateGenericTypeIsNotEnumException<T>();
        ...
        /// <param name="outValue">When this method returns true, contains the parsed enum value.</param>
        /// <returns>The enum value parsed from <paramref name="value"/>.</returns>
        public static bool TryParse<T>(string value, bool ignoreCase, out T outValue) where T : struct, IComparable, IConvertible, IFormattable
        {
            if (!typeof(T).IsEnum)
                throw CreateGenericTypeIsNotEnumException<T>();
