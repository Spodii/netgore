...
namespace SFML
{
    namespace Audio
    {
        ...
        public abstract class SoundStream : ObjectBase
        {
            ...
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            delegate bool StartCallbackType(IntPtr UserData);

            GetDataCallbackType myGetDataCallback;
            StartCallbackType myStartCallback;
            short[] myTempBuffer;
            ...
            static extern IntPtr sfSoundStream_Create(StartCallbackType OnStart, GetDataCallbackType OnGetData, uint ChannelsCount,
