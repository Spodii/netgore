...
namespace SFML
{
    namespace Window
    {
        ...
        public class Window : ObjectBase
        {
            ...
            ////////////////////////////////////////////////////////////
            public Window(VideoMode mode, string title, Styles style) : this(mode, title, style, new WindowSettings(24, 8, 0))
            {
            }
            ...
            ////////////////////////////////////////////////////////////
            public Window(IntPtr handle) : this(handle, new WindowSettings(24, 8, 0))
            {
            }
            ...
            /// <param name="settings">Creation parameters</param>
            ////////////////////////////////////////////////////////////
            public Window(IntPtr Handle, WindowSettings settings) : base(sfWindow_CreateFromHandle(Handle, settings))
            {
                myInput = new Input(sfWindow_GetInput(This));
            }
