...
namespace DemoGame.DbObjs
{
    ...
    public class StatTypeConstDictionary : IEnumerable<KeyValuePair<StatType, Int32>>, IPersistable
    {
        ...
        {
            _values = new Int32[_numEnumValues];
        }
        ...
        {
            get { return (Int32)_values[_enumToValueIndex[(int)key]]; }
            set { _values[_enumToValueIndex[(int)key]] = (Int16)value; }
        }
        ...
        public IEnumerator<KeyValuePair<StatType, Int32>> GetEnumerator()
        {
            ...
            {
                yield return new KeyValuePair<StatType, Int32>(_valueIndexToKey[i], (Int16)_values[i]);
            }
        }
        ...
        public void ReadState(IValueReader reader)
        {
            ...
            var values = reader.ReadManyNodes<KeyValuePair<StatType, Int32>>(_valuesNodeName, ReadValueHandler);
