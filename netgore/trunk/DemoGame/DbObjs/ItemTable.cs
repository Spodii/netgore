...
/// </summary>
 static  readonly System.String[] _dbColumns = new string[] {"action_display_id", "amount", "description", "equipped_body", "graphic", "height", "hp", "id", "item_template_id", "mp", "name", "range", "stat_agi", "stat_defence", "stat_int", "stat_maxhit", "stat_maxhp", "stat_maxmp", "stat_minhit", "stat_req_agi", "stat_req_int", "stat_req_str", "stat_str", "type", "value", "weapon_type", "width" };
/// <summary>
...
/// </summary>
 static  readonly System.String[] _dbColumnsNonKey = new string[] {"action_display_id", "amount", "description", "equipped_body", "graphic", "height", "hp", "item_template_id", "mp", "name", "range", "stat_agi", "stat_defence", "stat_int", "stat_maxhit", "stat_maxhp", "stat_maxmp", "stat_minhit", "stat_req_agi", "stat_req_int", "stat_req_str", "stat_str", "type", "value", "weapon_type", "width" };
/// <summary>
...
/// </summary>
public const System.Int32 ColumnCount = 27;
/// <summary>
...
/// </summary>
[System.ComponentModel.Description("The ActionDisplayID to use when using this item.")]
...
{
case "action_display_id":
return new ColumnMetadata("action_display_id", "The ActionDisplayID to use when using this item.", "smallint(5) unsigned", null, typeof(System.Nullable<System.UInt16>), true, false, false);
...
case "range":
return new ColumnMetadata("range", "", "smallint(5) unsigned", null, typeof(System.UInt16), false, false, false);
...
case "weapon_type":
return new ColumnMetadata("weapon_type", "", "tinyint(3) unsigned", null, typeof(System.Byte), false, false, false);
