...
{
/// <summary>
/// Interface for a class that can be used to serialize values to the database table `world_stats_guild_create`.
/// </summary>
public interface IWorldStatsGuildCreateTable
{
/// <summary>
...
/// </returns>
IWorldStatsGuildCreateTable DeepCopy();
