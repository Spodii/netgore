...
{
/// <summary>
/// Interface for a class that can be used to serialize values to the database table `world_stats_guild_destroy`.
/// </summary>
public interface IWorldStatsGuildDestroyTable
{
/// <summary>
...
/// </returns>
IWorldStatsGuildDestroyTable DeepCopy();
...
/// </summary>
System.Nullable<DemoGame.CharacterID> UserId
{
get;
}
/// <summary>
