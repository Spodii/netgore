...
namespace DemoGame.DbObjs
{
    ...
    public class ItemTemplateTable : IItemTemplateTable, IPersistable
    {
        ...
        {
            "ammo_type", "description", "equipped_body", "graphic", "height", "hp", "id", "mp", "name", "range", "stat_agi",
        ...
        {
            "ammo_type", "description", "equipped_body", "graphic", "height", "hp", "mp", "name", "range", "stat_agi",
            "stat_defence", "stat_int", "stat_maxhit", "stat_maxhp", "stat_maxmp", "stat_minhit", "stat_req_agi", "stat_req_int",
            "stat_req_str", "stat_str", "type", "value", "weapon_type", "width"
        };
        ...
        public ItemTemplateTable(Byte @ammoType, String @description, String @equippedBody, GrhIndex @graphic, Byte @height,
                                 SPValueType @hP, ItemTemplateID @iD, SPValueType @mP, String @name, UInt16 @range, Int16 @statAgi,
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "ammo_type":
                    return new ColumnMetadata("ammo_type", "", "tinyint(3) unsigned", null, typeof(Byte), false, false, false);
