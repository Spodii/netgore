...
namespace DemoGame.DbObjs
{
    ...
    public class ItemTemplateTable : IItemTemplateTable, IPersistable
    {
            ...
            switch (columnName)
            {
                ...
                case "description":
                    return new ColumnMetadata("description", "The item's textual description (don't include stuff like stats).",
                        "varchar(255)", " ", typeof(String), false, false, false);
                ...
                case "id":
                    return new ColumnMetadata("id", "The unique ID of the item template.", "smallint(5) unsigned", null,
                ...
                case "name":
                    return new ColumnMetadata("name", "The name of the item.", "varchar(255)", "New item template", typeof(String),
                        false, false, false);
                ...
                case "range":
                    return new ColumnMetadata("range",
                        ...
                        "smallint(5) unsigned", "10", typeof(UInt16), false, false, false);
        ...
        /// </summary>
        [Description("The unique ID of the item template.")]
        [SyncValue]
