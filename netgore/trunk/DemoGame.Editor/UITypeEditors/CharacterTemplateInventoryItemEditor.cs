...
{
    /// <summary>
    /// A <see cref="UITypeEditor"/> for selecting the <see cref="CharacterTemplateInventoryItemEditor"/>.
    /// </summary>
    public class CharacterTemplateInventoryItemEditor : UITypeEditor
    {
        /// <summary>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (svc != null)
            {
                var v = value as List<CharacterTemplateInventoryItem>;
                if (v == null)
                    return value;

                using (var editorForm = new CharacterTemplateInventoryItemListForm(v))
                {
