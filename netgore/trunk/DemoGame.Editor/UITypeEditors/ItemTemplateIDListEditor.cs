...
{
    /// <summary>
    /// A <see cref="UITypeEditor"/> for a list of <see cref="ItemTemplateID"/>s.
    /// </summary>
    public class ItemTemplateIDListEditor : UITypeEditor
    {
        /// <summary>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (svc != null)
            {
                var v = value as List<ItemTemplateID>;
                if (v == null)
                    return value;

                using (var editorForm = new ItemTemplateIDListForm(v))
                {
