...
{
    /// <summary>
    /// A <see cref="UITypeEditor"/> for a list of <see cref="SkillType"/>s.
    /// </summary>
    public class SkillTypeListEditor : UITypeEditor
    {
        /// <summary>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (svc != null)
            {
                var v = value as List<SkillType>;
                if (v == null)
                    return value;

                using (var editorForm = new SkillTypeListForm(v))
                {
