...
namespace DemoGame.Editor.UITypeEditors
{
    ...
    /// </summary>
    public class CharacterTemplateEquippedItemEditor : UITypeEditor
    {
        /// <summary>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (svc != null)
            {
                var v = value as List<CharacterTemplateEquippedItem>;
                if (v == null)
                    return value;

                using (var editorForm = new CharacterTemplateEquippedItemListForm(v))
                {
