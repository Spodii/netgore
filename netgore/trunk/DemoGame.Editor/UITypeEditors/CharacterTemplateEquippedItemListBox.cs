...
namespace DemoGame.Editor.UITypeEditors
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CharacterTemplateEquippedItemListBox"/> class.
        /// </summary>
        public CharacterTemplateEquippedItemListBox()
        {
            if (DesignMode)
                return;
        ...
        {
            if (DesignMode || !ControlHelper.DrawListItem<CharacterTemplateEquippedItem>(Items, e, x => GetDrawString(x)))
                base.OnDrawItem(e);
        }
        ...
        protected override void Sort()
        {
            ...
            var v = Items.Cast<CharacterTemplateEquippedItem>().OrderByDescending(x => x.Chance).ToImmutable();
            Items.Clear();
