...
namespace NetGore.Features.Guilds
{
    ...
    public struct GuildID : IComparable<GuildID>, IConvertible, IFormattable, IComparable<int>, IEquatable<int>
    {
        ...
        /// <summary>
        /// Reads a <see cref="GuildID"/> from an <see cref="IDataReader"/>.
        /// </summary>
        ...
        public static GuildID Read(IDataReader reader, int i)
        {
        ...
        /// <returns>The <see cref="GuildID"/> read from the <see cref="IDataReader"/>.</returns>
        public static GuildID Read(IDataReader reader, string name)
        {
