...
namespace DemoGame.EditorTools
{
    ...
    /// </summary>
    public class CharacterTemplateUITypeEditorForm : UITypeEditorDbListForm<CharacterTemplateTable>
    {
        ...
        /// </returns>
        protected override CharacterTemplateTable SetDefaultSelectedItem(IEnumerable<CharacterTemplateTable> items)
        {
            if (_selected == null)
            ...
            if (_selected is CharacterTemplateTable)
            {
                var asTable = (CharacterTemplateTable)_selected;
        ...
        protected override void DrawListItem(DrawItemEventArgs e, CharacterTemplateTable item)
        {
            e.DrawBackground();
        ...
        protected override IEnumerable<CharacterTemplateTable> GetListItems()
        {
            var ids = DbController.GetQuery<SelectCharacterTemplateIDsQuery>().Execute();

            List<CharacterTemplateTable> ret = new List<CharacterTemplateTable>();
