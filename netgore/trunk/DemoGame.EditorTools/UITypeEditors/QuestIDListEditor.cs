...
{
    /// <summary>
    /// A <see cref="UITypeEditor"/> for a list of <see cref="QuestID"/>s.
    /// </summary>
    public class QuestIDListEditor : UITypeEditor
    {
        /// <summary>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (svc != null)
            {
                var v = value as List<QuestID>;
                if (v == null)
                    return value;

                using (var editorForm = new QuestIDListForm(v))
                {
