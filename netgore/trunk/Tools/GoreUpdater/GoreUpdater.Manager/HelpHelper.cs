    ...
    public static class HelpHelper
    {
        ...
        static HelpHelper()
        {
            ...
            _deleteFilters = new HelpMessage("Delete filters",
                ...
                " and does not match ANY of the filters will be deleted after updating." + Environment.NewLine +
                Environment.NewLine +
                ...
                Environment.NewLine + Environment.NewLine + "Other important notes:" + Environment.NewLine +
