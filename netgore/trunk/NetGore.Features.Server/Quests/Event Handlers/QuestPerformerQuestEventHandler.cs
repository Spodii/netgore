...
namespace NetGore.Features.Quests
{
    ...
    public delegate void QuestPerformerQuestEventHandler<TCharacter>(TCharacter questPerformer, IQuest<TCharacter> quest) where TCharacter : IQuestPerformer<TCharacter>;
}