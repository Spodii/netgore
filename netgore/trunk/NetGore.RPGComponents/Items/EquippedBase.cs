...
{
    public abstract class EquippedBase<TItem, TItemType, TEquipmentSlot> : IEnumerable<KeyValuePair<TEquipmentSlot, TItem>>
        ...
        where TEquipmentSlot : struct, IComparable, IConvertible, IFormattable
    {
        ...
        /// </summary>
        public event EquippedEventHandler<TItem, TItemType, TEquipmentSlot> OnEquip;

        /// <summary>
        /// Notifies listeners that an item has been unequipped.
        /// </summary>
        public event EquippedEventHandler<TItem, TItemType, TEquipmentSlot> OnRemove;
        ...
        public TItem this[TEquipmentSlot slot]
        {
            get { return this[ToInt(slot)]; }
        }
        ...
        public abstract bool CanEquip(TItem item);
        ...
        protected abstract bool CanRemove(TEquipmentSlot slot);
        ...
        /// <summary>
        /// When overridden in the derived class, gets the <typeparamref name="TEquipmentSlot"/> from an integer.
        /// </summary>
        /// <param name="value">The value to convert to type <typeparamref name="TEquipmentSlot"/>.</param>
        /// <returns>The <paramref name="value"/> as type <typeparamref name="TEquipmentSlot"/>.</returns>
        protected abstract TEquipmentSlot EquipmentSlotFromInt(int value);

        /// <summary>
        /// Gets an IEnumerable of <typeparamref name="TEquipmentSlot"/>s possible for a given item.
        /// </summary>
        /// <param name="item">Item to get the possible <typeparamref name="TEquipmentSlot"/>s for.</param>
        /// <returns>An IEnumerable of <typeparamref name="TEquipmentSlot"/>s possible for the
        /// <paramref name="item"/>.</returns>
        protected abstract IEnumerable<TEquipmentSlot> GetPossibleSlots(TItem item);
        ...
        public bool RemoveAt(TEquipmentSlot slot)
        {
            return TrySetSlot(slot, null, false);
        }

        /// <summary>
        /// When overridden in the derived class, gets the integer value of the <typeparamref name="TEquipmentSlot"/>.
        /// </summary>
        /// <param name="value">The value to convert to an int.</param>
        /// <returns>The <paramref name="value"/> as an int.</returns>
        protected abstract int ToInt(TEquipmentSlot value);
        ...
        protected bool TrySetSlot(TEquipmentSlot slot, TItem item)
        {
        ...
        /// <paramref name="slot"/>, else false. When false, it is guarenteed the equipment will
        /// not have been modified.</returns>
        bool TrySetSlot(TEquipmentSlot slot, TItem item, bool checkIfCanEquip)
        {
            // Check for a valid EquipmentSlot
            if (!EnumHelper<TEquipmentSlot>.IsDefined(slot))
            {
        ...
        #region IEnumerable<KeyValuePair<TEquipmentSlot,TItem>> Members
