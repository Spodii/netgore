...
namespace NetGore.RPGComponents
{
    ...
    public interface IStatCollection<T> : IEnumerable<IStat<T>> where T : struct, IComparable, IConvertible, IFormattable
    {
        /// <summary>
        ...
        void CopyValuesFrom(IEnumerable<KeyValuePair<T, int>> values, bool checkContains);
        ...
        /// the same as if the value of a StatType not in this IStatCollection was attempted to be assigned
        /// in any other way.</param>
        void CopyValuesFrom(IEnumerable<IStat<T>> values, bool checkContains);
        ...
        IEnumerable<KeyValuePair<T, int>> ToKeyValuePairs();
        ...
        bool TryGetStat(T statType, out IStat<T> stat);
        ...
        /// <returns>True if the stat with the given <paramref name="statType"/> was found and
        /// successfully returned; otherwise false.</returns>
        bool TryGetStatValue(T statType, out int value);
    }
}