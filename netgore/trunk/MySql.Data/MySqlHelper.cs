    ...
    public static class MySqlHelper
    {
                                             ...
                                             params MySqlParameter[] commandParameters)
        {
            ...
            MySqlCommand cmd = new MySqlCommand
                               { Connection = connection, CommandText = commandText, CommandType = CommandType.Text };
        ...
        /// <returns><see cref="MySqlDataReader"/> object ready to read the results of the command</returns>
        static MySqlDataReader ExecuteReader(MySqlConnection connection, MySqlTransaction transaction, string commandText,
                                             IEnumerable<MySqlParameter> commandParameters, bool ExternalConn)
        {
            //create a command and prepare it for execution
            MySqlCommand cmd = new MySqlCommand
                               {
                                   Connection = connection, Transaction = transaction, CommandText = commandText,
