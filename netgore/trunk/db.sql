...
INSERT INTO `account` VALUES (1,'Spodi','3fc0a7acf087f549ac2b266baf94b8b1','spodi@netgore.com',255,'2009-09-07 15:43:16','2012-12-12 22:55:50',16777343,NULL),(2,'Spodii','3FC0A7ACF087F549AC2B266BAF94B8B1','test@test.com',0,'2010-12-26 14:11:08','2010-12-26 14:14:23',16777343,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=186 DEFAULT CHARSET=latin1 COMMENT='The IPs used to access accounts.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `character` VALUES (1,NULL,'Spodi',NULL,NULL,NULL,1,481,937,1,1024,600,1,1800,203525,101,3020,497,100,100,100,100,1,1,1,1,3,2);
...
INSERT INTO `character_equipped` VALUES (1,14,1),(1,21,2);
...
INSERT INTO `character_inventory` VALUES (1,2,1),(1,6,3),(1,7,4),(1,11,0),(1,12,2),(1,22,6),(1,23,5);
...
INSERT INTO `character_template_inventory` VALUES (0,1,5,0,2,10000),(1,6,4,1,1,66),(2,1,3,1,1,5000),(3,1,5,0,2,10000),(5,6,3,1,1,655),(6,6,8,1,1,655),(7,1,3,1,1,5000),(8,1,3,1,1,5000),(9,1,7,1,10,65535),(10,1,3,1,1,5000),(11,1,7,1,10,65535),(12,1,3,1,1,5000),(13,1,5,0,2,10000),(14,1,7,1,10,65535),(15,1,3,1,1,5000),(16,1,7,1,10,65535),(17,6,6,1,1,655),(18,6,7,1,1,655),(19,6,5,1,1,3277),(20,6,2,1,1,6554),(21,6,1,1,1,6554);
...
INSERT INTO `event_counters_item_template` VALUES (1,0,25),(1,5,12),(1,6,12),(2,0,28),(2,1,5),(2,5,26),(2,6,10),(3,0,5012),(3,4,435),(3,5,38),(3,6,55),(3,8,12),(4,0,1),(5,0,3847),(5,5,47),(5,6,70),(5,8,13),(6,0,5),(6,4,29),(6,5,26),(6,6,2),(7,0,101857),(7,4,1),(7,5,105),(7,6,2383),(7,8,564),(8,0,531),(8,5,2),(8,6,2);
...
INSERT INTO `event_counters_map` VALUES (1,0,91),(1,1,3513),(1,2,2366),(1,3,97),(1,4,97),(1,5,15),(1,6,90),(1,7,405),(1,8,500),(2,0,11),(2,1,1465),(2,2,14),(2,3,61),(2,4,61),(2,7,240);
...
INSERT INTO `event_counters_npc` VALUES (1,2,100),(1,3,2143),(1,5,453),(1,7,393),(1,8,79),(6,1,4),(6,4,2363),(6,6,1129),(6,7,1129),(6,8,1129);
...
INSERT INTO `event_counters_user` VALUES (1,2,61),(1,4,443),(1,6,2107),(1,7,85),(1,8,1269);
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=latin1 COMMENT='The live, persisted items.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `map` VALUES (1,'Town'),(2,'Jail');
...
INSERT INTO `map_spawn` VALUES (5,2,6,45,130,165,720,475),(9,1,1,3,NULL,NULL,NULL,NULL),(11,1,2,1,600,580,32,32),(12,1,4,1,750,580,32,32),(13,1,5,1,400,580,32,32);
...
INSERT INTO `server_time` VALUES ('2012-12-12 22:56:10');
...
INSERT INTO `world_stats_count_item_create` VALUES (1,25,'2012-12-13 06:55:49'),(2,34,'2012-12-13 06:56:12'),(3,9103,'2012-12-13 06:56:02'),(4,1,'2012-12-13 06:44:51'),(5,7029,'2012-12-13 06:55:49'),(6,6,'2012-12-13 06:55:49'),(7,130308,'2012-12-13 06:56:02'),(8,531,'2012-12-13 06:56:12');
...
INSERT INTO `world_stats_count_user_kill_npc` VALUES (1,1,103,'2012-12-13 06:56:02'),(1,6,30,'2012-12-13 06:47:09');
...
) ENGINE=InnoDB AUTO_INCREMENT=134 DEFAULT CHARSET=latin1 COMMENT='Event log: User kills NPC.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-12-12 22:56:44
