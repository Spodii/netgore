...
INSERT INTO `account` VALUES (1,'Spodi','3fc0a7acf087f549ac2b266baf94b8b1','spodi@netgore.com',255,'2009-09-07 15:43:16','2012-12-12 21:52:14',16777343,NULL),(2,'Spodii','3FC0A7ACF087F549AC2B266BAF94B8B1','test@test.com',0,'2010-12-26 14:11:08','2010-12-26 14:14:23',16777343,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=183 DEFAULT CHARSET=latin1 COMMENT='The IPs used to access accounts.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `character` VALUES (1,NULL,'Spodi',NULL,NULL,NULL,2,479,411,1,1024,600,1,1800,203270,93,2765,457,100,100,100,100,1,1,1,1,3,2);
...
INSERT INTO `character_template_inventory` VALUES (0,1,5,0,2,10000),(2,1,3,1,1,5000),(3,1,5,0,2,10000),(4,1,7,1,10,65535),(7,1,3,1,1,5000),(8,1,3,1,1,5000),(9,1,7,1,10,65535),(10,1,3,1,1,5000),(11,1,7,1,10,65535),(12,1,3,1,1,5000),(13,1,5,0,2,10000),(14,1,7,1,10,65535),(15,1,3,1,1,5000),(16,1,7,1,10,65535);
...
INSERT INTO `event_counters_item_template` VALUES (2,1,5),(2,5,16),(3,0,4997),(3,4,401),(3,5,35),(3,6,51),(3,8,12),(5,0,3835),(5,5,45),(5,6,67),(5,8,13),(6,5,24),(7,0,101553),(7,4,1),(7,5,101),(7,6,2319),(7,8,564),(8,0,332);
...
INSERT INTO `event_counters_map` VALUES (1,0,85),(1,1,3492),(1,2,2297),(1,3,94),(1,4,94),(1,5,15),(1,6,90),(1,7,405),(1,8,500),(2,0,2),(2,1,1278),(2,3,4),(2,4,4);
...
INSERT INTO `event_counters_npc` VALUES (1,2,100),(1,3,2143),(1,5,453),(1,7,393),(1,8,79),(6,1,4),(6,4,1129),(6,6,1129),(6,7,1129),(6,8,1129);
...
INSERT INTO `server_time` VALUES ('2012-12-12 21:52:32');
...
INSERT INTO `world_stats_count_item_create` VALUES (2,6,'2010-12-09 10:26:47'),(3,9088,'2012-12-13 05:52:13'),(5,7017,'2012-12-13 05:52:13'),(6,1,'2010-12-16 20:55:11'),(7,130004,'2012-12-13 05:52:13'),(8,332,'2012-12-13 05:52:13');
...
INSERT INTO `world_stats_count_user_kill_npc` VALUES (1,1,100,'2012-12-13 05:49:03');
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=latin1 COMMENT='Event log: User kills NPC.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `world_stats_user_level` (
  ...
  `when` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'When this event took place.',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=latin1 COMMENT='Event log: User levels up.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-12-12 22:01:31
