...
INSERT INTO `account` VALUES (0,'Test','3fc0a7acf087f549ac2b266baf94b8b1','test@test.com','2010-02-11 17:52:28','2010-02-11 18:03:56',16777343,NULL),(1,'Spodi','3fc0a7acf087f549ac2b266baf94b8b1','spodi@netgore.com','2009-09-07 15:43:16','2010-02-19 15:49:37',16777343,NULL);
...
INSERT INTO `character` VALUES (0,0,NULL,'Test',1,NULL,NULL,NULL,391.6,244,NULL,50,50,1,1800,0,1,0,0,50,50,50,50,1,1,1,1,1,1),(1,1,NULL,'Spodi',1,NULL,NULL,NULL,713.399,658,1,500,200,1,1800,3671,145,4349,698,50,50,50,50,7,12,0,1,1,2),(2,NULL,1,'Test A',2,NULL,NULL,1,800,250,2,800,250,1,1800,3012,12,810,527,5,5,5,5,5,5,0,5,5,5),(3,NULL,1,'Test B',2,NULL,NULL,1,506,250,2,500,250,1,1800,3012,12,810,527,5,5,5,5,5,5,0,5,5,5),(4,NULL,NULL,'Talking Guy',2,NULL,0,NULL,800,530,2,800,530,1,1800,0,1,0,0,50,50,50,50,1,1,0,1,1,1),(5,NULL,NULL,'Shopkeeper',2,0,NULL,NULL,600,530,2,600,530,1,1800,0,1,0,0,50,50,50,50,1,1,0,1,1,1),(6,NULL,NULL,'Vending Machine',2,1,NULL,NULL,500,530,2,500,530,1,1800,0,1,0,0,50,50,50,50,1,1,0,1,1,1);
...
--
-- Table structure for table `character_quest_provider`
--

DROP TABLE IF EXISTS `character_quest_provider`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `character_quest_provider` (
  `character_id` int(11) NOT NULL COMMENT 'The character that is providing the quest.',
  `quest_id` smallint(5) unsigned NOT NULL COMMENT 'The quest that the character provides.',
  PRIMARY KEY (`character_id`,`quest_id`),
  KEY `quest_id` (`quest_id`),
  CONSTRAINT `character_quest_provider_ibfk_1` FOREIGN KEY (`character_id`) REFERENCES `character` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `character_quest_provider_ibfk_2` FOREIGN KEY (`quest_id`) REFERENCES `guild` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `character_quest_provider`
--

LOCK TABLES `character_quest_provider` WRITE;
/*!40000 ALTER TABLE `character_quest_provider` DISABLE KEYS */;
/*!40000 ALTER TABLE `character_quest_provider` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `server_time` VALUES ('2010-02-19 15:49:50');
...
-- Dump completed on 2010-02-19 15:50:07
