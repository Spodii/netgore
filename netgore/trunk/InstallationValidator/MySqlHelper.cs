...
namespace InstallationValidator
{
    public static class MySqlHelper
    {
        ...
        public static readonly string DBSettingsFile = string.Format("DemoGame.ServerObjs{0}DbSettings.xml", Path.DirectorySeparatorChar);
        ...
        {
            var filePath =
                FileFinder.Find(fileName, Environment.GetEnvironmentVariable("ProgramFiles(x86)") + Path.DirectorySeparatorChar + "MySql") ??
                FileFinder.Find(fileName, Environment.GetEnvironmentVariable("ProgramFiles") + Path.DirectorySeparatorChar + "MySql");
        ...
        static void ImportDatabaseContents()
        {
            ...
            {
                "DROP DATABASE IF EXISTS " + ConnectionSettings.SqlDatabase + ";",
                "CREATE DATABASE " + ConnectionSettings.SqlDatabase + ";", "USE " + ConnectionSettings.SqlDatabase + ";",
                "SOURCE " + dbFile, "exit"
            };
        ...
        public static bool TestMySqlCommand(string testName, string command, string[] cmds, bool print)
        {
            ...
            {
                string username = ConnectionSettings.SqlUser;
                string password = ConnectionSettings.SqlPass;
                string host = ConnectionSettings.SqlHost;
        ...
        public static void AskToImportDatabase(bool dbExists)
        {
            ...
            Tester.Write(string.Format("\n" + s + "\n", ConnectionSettings.SqlDatabase), ConsoleColor.Green);
