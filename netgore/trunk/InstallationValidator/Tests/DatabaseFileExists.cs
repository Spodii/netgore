...
namespace InstallationValidator.Tests
{
    public sealed class DatabaseFileExists : TestableBase
    {
        ...
        const string _description = "Checks that the database connection settings file exists. This file is vital to determining how to make the connection to the database.";
        const string _failMessage = "The database settings file does not exist at the path expected path:\n{0}\n\nThe file should be located at this path by default. If you moved it, you should probably move it back.";
        
        /// <summary>
        /// Initializes a new instance of the <see cref="DatabaseFileExists"/> class.
        /// </summary>
        public DatabaseFileExists()
        ...
        {
            bool success = File.Exists(MySqlHelper.DbSettingsFile);
