    ...
    public abstract class Inventory : InventoryBase<ItemEntity>
    {
        ...
        protected override void HandleSlotChanged(int slot, ItemEntity newItem, ItemEntity oldItem)
        {
            ...
            if (newItem == null)
            {
                ...
                // Update the database
                if (!_isLoading)
                    DbController.DeleteCharacterInventoryItem.Execute(oldItem.ID); //!! DeleteCharacterItem
            ...
            else
            {
                ...
                if (!_isLoading)
                {
                    var args = new InsertCharacterInventoryItemQuery.QueryArgs(Character.ID, newItem.ID); //!! InsertCharacterItem
