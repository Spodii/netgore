...
namespace DemoGame.Server.Queries
{
    ...
    {
        static readonly string _queryStr = string.Format("UPDATE `{0}` SET `tag`=@value WHERE `id`=@id", GuildTable.TableName);
        ...
        public UpdateGuildTagQuery(DbConnectionPool connectionPool)
