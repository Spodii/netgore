...
namespace DemoGame.Server.Queries
{
    ...
    {
        static readonly string _queryStr = string.Format("REPLACE INTO `{0}` {1}", ItemTemplateTable.TableName,
        ...
        {
            return CreateParameters(ItemTemplateTable.DbColumns.Select(x => "@" + x));
        }
