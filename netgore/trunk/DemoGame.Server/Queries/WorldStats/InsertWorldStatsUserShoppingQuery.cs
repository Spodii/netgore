...
namespace DemoGame.Server.Queries
{
    ...
    {
        static readonly string _queryStr = string.Format("INSERT INTO `{0}` {1}", WorldStatsUserShoppingTable.TableName,
        ...
        {
            return CreateParameters(WorldStatsUserShoppingTable.DbColumns.Select(x => "@" + x));
        }
        ...
        protected override void SetParameters(DbParameterValues p, IWorldStatsUserShoppingTable item)
        {
            item.CopyValues(p);
        }
    }
