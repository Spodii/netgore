...
namespace DemoGame.Server.Queries
{
    ...
    {
        static readonly string _queryStr = FormatQueryString("INSERT INTO `{0}` {1}", WorldStatsNpcKillUserTable.TableName,
        ...
        {
            return CreateParameters(WorldStatsNpcKillUserTable.DbColumns);
        }
