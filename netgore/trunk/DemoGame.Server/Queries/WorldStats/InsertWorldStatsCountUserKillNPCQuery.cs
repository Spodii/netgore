    ...
    public class InsertWorldStatsCountUserKillNPCQuery : DbQueryNonReader<KeyValuePair<int, int>>
    {
        static readonly string _queryStr =
            FormatQueryString(
                ...
                " ON DUPLICATE KEY UPDATE `count`=`count`+1", WorldStatsCountUserKillNpcTable.TableName);
        ...
        public InsertWorldStatsCountUserKillNPCQuery(DbConnectionPool connectionPool) : base(connectionPool, _queryStr)
        {
