...
namespace DemoGame.Server.Queries
{
    ...
    {
        static readonly string _queryStr = FormatQueryString("REPLACE INTO `{0}` {1}", WorldStatsQuestCancelTable.TableName,
        ...
        {
            return CreateParameters(WorldStatsQuestCancelTable.DbColumns);
        }
