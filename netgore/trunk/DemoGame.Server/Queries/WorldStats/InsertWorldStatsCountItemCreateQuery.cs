...
namespace DemoGame.Server.Queries
{
    ...
    public class InsertWorldStatsCountItemCreateQuery : DbQueryNonReader<KeyValuePair<int, int>>
    {
        ...
        static string CreateQuery(IQueryBuilder qb)
        {
            ...
            var s = qb.Settings;
            var f = qb.Functions;
            var q = qb.Insert(WorldStatsCountItemCreateTable.TableName)
        ...
        public InsertWorldStatsCountItemCreateQuery(DbConnectionPool connectionPool) : base(connectionPool, CreateQuery(connectionPool.QueryBuilder))
        {
