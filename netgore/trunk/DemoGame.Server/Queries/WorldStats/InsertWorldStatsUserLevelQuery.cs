...
namespace DemoGame.Server.Queries
{
    ...
    {
        static readonly string _queryStr = string.Format("INSERT INTO `{0}` {1}", WorldStatsUserLevelTable.TableName,
        ...
        {
            return CreateParameters(WorldStatsUserLevelTable.DbColumns.Select(x => "@" + x));
        }
        ...
        protected override void SetParameters(DbParameterValues p, IWorldStatsUserLevelTable item)
        {
            item.CopyValues(p);
        }
    }
