...
{
    [DbControllerQuery]
    public class DeleteCharacterTemplateQuestProviderForCharacterQuery : DbQueryNonReader<CharacterTemplateID>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteCharacterTemplateQuestProviderForCharacterQuery"/> class.
        /// </summary>
        /// <param name="connectionPool">The connection pool.</param>
        public DeleteCharacterTemplateQuestProviderForCharacterQuery(DbConnectionPool connectionPool)
