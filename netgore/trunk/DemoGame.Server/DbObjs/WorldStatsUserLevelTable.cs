    ...
    public class WorldStatsUserLevelTable : IWorldStatsUserLevelTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "map_id":
                    return new ColumnMetadata("map_id", "", "smallint(5) unsigned", null, typeof(ushort?), true, false, false);
                ...
                case "x":
                    return new ColumnMetadata("x", "", "smallint(5) unsigned", null, typeof(UInt16), false, false, false);

                case "y":
                    return new ColumnMetadata("y", "", "smallint(5) unsigned", null, typeof(UInt16), false, false, false);
