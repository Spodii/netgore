...
case "guild_event_counter_id":
return new ColumnMetadata("guild_event_counter_id", "", "tinyint(3) unsigned", null, typeof(System.Byte), false, true, false);

case "guild_id":
return new ColumnMetadata("guild_id", "", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);
