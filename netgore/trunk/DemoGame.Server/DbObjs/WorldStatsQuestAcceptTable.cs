...
namespace DemoGame.Server.DbObjs
{
    ...
    /// </summary>
    public class WorldStatsQuestAcceptTable : IWorldStatsQuestAcceptTable, IPersistable
    {
        /// <summary>
        ...
        /// </summary>
        public const String TableName = "world_stats_quest_accept";
        ...
        public WorldStatsQuestAcceptTable(UInt32 @iD, MapID? @mapID, QuestID @questID, CharacterID @userID, DateTime @when,
                                          UInt16 @x, UInt16 @y)
        {
            ID = @iD;
            MapID = @mapID;
        ...
        #region IWorldStatsQuestAcceptTable Members
