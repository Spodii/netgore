...
namespace DemoGame.Server.DbObjs
{
    ...
    public class WorldStatsQuestAcceptTable : IWorldStatsQuestAcceptTable, IPersistable
    {
        ...
        /// <summary>
        /// WorldStatsQuestAcceptTable constructor.
        /// </summary>
        ...
        public WorldStatsQuestAcceptTable(MapID? @mapID, QuestID @questID, CharacterID @userId, DateTime @when, UInt16 @x,
                                          UInt16 @y)
        {
            MapID = @mapID;
            QuestID = @questID;
        ...
        /// </returns>
        public IWorldStatsQuestAcceptTable DeepCopy()
        {
