...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTemplateTable : ICharacterTemplateTable, IPersistable
    {
        ...
        public CharacterTemplateTable(AIID? @aIID, AllianceID @allianceID, BodyIndex @bodyID, ushort? @chatDialog, Int32 @exp,
                                      UInt16 @giveCash, UInt16 @giveExp, CharacterTemplateID @iD, Byte @level, UInt16 @moveSpeed,
                                      String @name, UInt16 @respawn, ShopID? @shopID, Int32 @statPoints, Int16 @statAgi,
