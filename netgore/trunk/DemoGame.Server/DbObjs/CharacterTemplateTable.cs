...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTemplateTable : ICharacterTemplateTable
    {
        ...
        {
            "ai_id", "alliance_id", "body_id", "exp", "give_cash", "give_exp", "id", "level", "move_speed", "name", "respawn",
            "shop_id", "stat_agi", "stat_defence", "stat_int", "stat_maxhit", "stat_maxhp", "stat_maxmp", "stat_minhit", "stat_str",
            "statpoints"
        };
        ...
        {
            "ai_id", "alliance_id", "body_id", "exp", "give_cash", "give_exp", "level", "move_speed", "name", "respawn", "shop_id",
        ...
        public CharacterTemplateTable(AIID? @aIID, AllianceID @allianceID, BodyIndex @bodyID, Int32 @exp, UInt16 @giveCash,
                                      UInt16 @giveExp, CharacterTemplateID @iD, Byte @level, UInt16 @moveSpeed, String @name,
                                      UInt16 @respawn, ShopID? @shopID, Int16 @statAgi, Int16 @statDefence, Int16 @statInt,
                                      Int16 @statMaxhit, Int16 @statMaxhp, Int16 @statMaxmp, Int16 @statMinhit, Int16 @statStr,
                                      Int32 @statPoints)
        {
            AIID = @aIID;
