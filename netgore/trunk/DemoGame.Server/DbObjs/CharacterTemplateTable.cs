...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTemplateTable : ICharacterTemplateTable, IPersistable
    {
        ...
        static readonly String[] _dbColumns = new string[]
        {
            ...
            "shop_id", "statpoints", "stat_agi", "stat_defence", "stat_int", "stat_maxhit", "stat_maxhp", "stat_maxmp",
        ...
        public CharacterTemplateTable(AIID? @aIID, AllianceID @allianceID, BodyIndex @bodyID, Int32 @exp, UInt16 @giveCash,
                                      ...
                                      UInt16 @respawn, ShopID? @shopID, Int32 @statPoints, Int16 @statAgi, Int16 @statDefence,
