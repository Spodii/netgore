...
namespace DemoGame.Server.DbObjs
{
    ...
    public class AccountTable : IAccountTable, IPersistable
    {
        ...
        { "creator_ip", "current_ip", "email", "id", "name", "password", "permissions", "time_created", "time_last_login" };
        ...
        { "creator_ip", "current_ip", "email", "name", "password", "permissions", "time_created", "time_last_login" };
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "id":
                    return new ColumnMetadata("id", "The unique ID of the account.", "int(11)", null, typeof(Int32), false, true,
                        false);
                ...
                case "password":
                    return new ColumnMetadata("password", "The account password (MD5 hashed).", "char(32)", null, typeof(String),
                        false, false, false);

                case "permissions":
                    return new ColumnMetadata("permissions", "The permission level bit mask (see UserPermissions enum).",
                        "tinyint(3) unsigned", "0", typeof(Byte), false, false, false);

                case "time_created":
                    return new ColumnMetadata("time_created", "When the account was created.", "datetime", null, typeof(DateTime),
                        false, false, false);

                case "time_last_login":
                    return new ColumnMetadata("time_last_login", "When the account was last logged in to.", "datetime", null,
