        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "shop_event_counter_id":
                    return new ColumnMetadata("shop_event_counter_id", "The ID of the event that the counter is for.",
                        "tinyint(3) unsigned", null, typeof(Byte), false, true, false);

                case "shop_id":
                    return new ColumnMetadata("shop_id", "The shop the event occured on.", "smallint(5) unsigned", null,
