...
namespace DemoGame.Server.DbObjs
{
    ...
    /// </summary>
    public class WorldStatsCountItemSellTable : IWorldStatsCountItemSellTable, IPersistable
    {
        /// <summary>
        ...
        /// </summary>
        public const String TableName = "world_stats_count_item_sell";
        ...
        public WorldStatsCountItemSellTable(Int32 @count, ItemTemplateID @itemTemplateID, DateTime @lastUpdate)
        {
            Count = @count;
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "count":
                    return new ColumnMetadata("count", "Amount of this item template that has been sold to stores.", "int(11)",
                        "0", typeof(Int32), false, false, false);

                case "item_template_id":
                    return new ColumnMetadata("item_template_id", "The item template this counter is for.", "smallint(5) unsigned",
        ...
        #region IWorldStatsCountItemSellTable Members
