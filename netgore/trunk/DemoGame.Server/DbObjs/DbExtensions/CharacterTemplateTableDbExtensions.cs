...
/// <summary>
/// Checks if this <see cref="ICharacterTemplateTable"/> contains the same values as an<paramref name="other"/> <see cref="ICharacterTemplateTable"/>.
/// </summary>
/// <param name="other">The <see cref="ICharacterTemplateTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="ICharacterTemplateTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
/// </returns>
public static System.Boolean HasSameValues(this ICharacterTemplateTable source, ICharacterTemplateTable other)
{
return Equals(source.AIID, other.AIID) && 
Equals(source.AllianceID, other.AllianceID) && 
Equals(source.BodyID, other.BodyID) && 
Equals(source.ChatDialog, other.ChatDialog) && 
Equals(source.Exp, other.Exp) && 
Equals(source.GiveCash, other.GiveCash) && 
Equals(source.GiveExp, other.GiveExp) && 
Equals(source.ID, other.ID) && 
Equals(source.Level, other.Level) && 
Equals(source.MoveSpeed, other.MoveSpeed) && 
Equals(source.Name, other.Name) && 
Equals(source.Respawn, other.Respawn) && 
