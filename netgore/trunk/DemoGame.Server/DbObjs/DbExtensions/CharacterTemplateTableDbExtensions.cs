...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterTemplateTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this ICharacterTemplateTable source, ICharacterTemplateTable other)
        {
            return Equals(source.AIID, other.AIID) && Equals(source.AllianceID, other.AllianceID) &&
                   Equals(source.BodyID, other.BodyID) && Equals(source.ChatDialog, other.ChatDialog) &&
                   Equals(source.Exp, other.Exp) && Equals(source.GiveCash, other.GiveCash) &&
                   Equals(source.GiveExp, other.GiveExp) && Equals(source.ID, other.ID) && Equals(source.Level, other.Level) &&
                   Equals(source.MoveSpeed, other.MoveSpeed) && Equals(source.Name, other.Name) &&
                   Equals(source.Respawn, other.Respawn) && Equals(source.ShopID, other.ShopID) &&
                   ...
                   Equals(source.GetStat(StatType.Str), other.GetStat(StatType.Str));
        }
