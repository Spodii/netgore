...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class GuildMemberTableDbExtensions
    {
        ...
        /// <summary>
        /// Checks if this <see cref="IGuildMemberTable"/> contains the same values as an<paramref name="other"/> <see cref="IGuildMemberTable"/>.
        /// </summary>
        /// <param name="other">The <see cref="IGuildMemberTable"/> to compare the values to.</param>
        /// <returns>
        /// True if this <see cref="IGuildMemberTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
        /// </returns>
        public static Boolean HasSameValues(this IGuildMemberTable source, IGuildMemberTable other)
        {
            return Equals(source.CharacterID, other.CharacterID) && Equals(source.GuildID, other.GuildID) &&
                   Equals(source.Joined, other.Joined) && Equals(source.Rank, other.Rank);
        }
