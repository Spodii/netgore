...
/// </returns>
public static System.Boolean HasSameValues(this IGuildMemberTable source, IGuildMemberTable other)
{
return Equals(source.CharacterID, other.CharacterID) && 
Equals(source.GuildID, other.GuildID) && 
Equals(source.Joined, other.Joined) && 
Equals(source.Rank, other.Rank);
}
