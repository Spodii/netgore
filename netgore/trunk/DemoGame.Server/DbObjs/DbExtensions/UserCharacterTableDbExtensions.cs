...
/// <summary>
/// Checks if this <see cref="IUserCharacterTable"/> contains the same values as an<paramref name="other"/> <see cref="IUserCharacterTable"/>.
/// </summary>
/// <param name="other">The <see cref="IUserCharacterTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="IUserCharacterTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
/// </returns>
public static System.Boolean HasSameValues(this IUserCharacterTable source, IUserCharacterTable other)
{
...
Equals(source.StatAgi, other.StatAgi) && 
Equals(source.StatDefence, other.StatDefence) && 
Equals(source.StatInt, other.StatInt) && 
Equals(source.StatMaxhit, other.StatMaxhit) && 
Equals(source.StatMaxhp, other.StatMaxhp) && 
Equals(source.StatMaxmp, other.StatMaxmp) && 
Equals(source.StatMinhit, other.StatMinhit) && 
Equals(source.StatStr, other.StatStr) && 
