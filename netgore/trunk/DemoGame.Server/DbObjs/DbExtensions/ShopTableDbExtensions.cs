...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class ShopTableDbExtensions
    {
        ...
        /// <summary>
        /// Checks if this <see cref="IShopTable"/> contains the same values as an<paramref name="other"/> <see cref="IShopTable"/>.
        /// </summary>
        /// <param name="other">The <see cref="IShopTable"/> to compare the values to.</param>
        /// <returns>
        /// True if this <see cref="IShopTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
        /// </returns>
        public static Boolean HasSameValues(this IShopTable source, IShopTable other)
        {
            return Equals(source.CanBuy, other.CanBuy) && Equals(source.ID, other.ID) && Equals(source.Name, other.Name);
        }
