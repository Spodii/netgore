...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class WorldStatsNpcKillUserTableDbExtensions
    {
        ...
        public static void ReadValues(this WorldStatsNpcKillUserTable source, IDataRecord dataRecord)
        {
            Int32 i;
        ...
        public static void TryReadValues(this WorldStatsNpcKillUserTable source, IDataRecord dataRecord)
        {
