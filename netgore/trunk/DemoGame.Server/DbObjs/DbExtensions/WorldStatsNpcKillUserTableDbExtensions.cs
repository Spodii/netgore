...
public static void ReadValues(this WorldStatsNpcKillUserTable source, System.Data.IDataReader dataReader)
{
System.Int32 i;
...
source.NpcTemplateId = (System.Nullable<System.UInt16>)(System.Nullable<System.UInt16>)(dataReader.IsDBNull(i) ? (System.Nullable<System.UInt16>)null : dataReader.GetUInt16(i));
...
/// <param name="source">The object to add the extension method to.</param>
/// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
public static void TryReadValues(this WorldStatsNpcKillUserTable source, System.Data.IDataReader dataReader)
{
