...
/// </returns>
public static System.Boolean HasSameValues(this ICharacterQuestStatusTable source, ICharacterQuestStatusTable other)
{
return Equals(source.CharacterID, other.CharacterID) && 
Equals(source.CompletedOn, other.CompletedOn) && 
Equals(source.QuestID, other.QuestID) && 
Equals(source.StartedOn, other.StartedOn);
}
