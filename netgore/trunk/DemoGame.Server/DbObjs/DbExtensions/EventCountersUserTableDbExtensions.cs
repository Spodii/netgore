...
{
paramValues["character_event_counter_id"] = (System.Byte)source.CharacterEventCounterId;
...
source.CharacterEventCounterId = (System.Byte)(System.Byte)dataRecord.GetByte(i);
...
{
case "character_event_counter_id":
paramValues[i] = (System.Byte)source.CharacterEventCounterId;
break;
...
Equals(source.Counter, otherItem.Counter);
}
