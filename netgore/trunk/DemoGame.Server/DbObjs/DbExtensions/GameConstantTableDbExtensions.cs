...
/// </returns>
public static System.Boolean HasSameValues(this IGameConstantTable source, IGameConstantTable other)
{
...
Equals(source.MaxInventorySize, other.MaxInventorySize) && 
Equals(source.MaxShopItems, other.MaxShopItems) && 
...
Equals(source.ScreenHeight, other.ScreenHeight) && 
Equals(source.ScreenWidth, other.ScreenWidth) && 
Equals(source.ServerIp, other.ServerIp) && 
Equals(source.ServerPingPort, other.ServerPingPort) && 
