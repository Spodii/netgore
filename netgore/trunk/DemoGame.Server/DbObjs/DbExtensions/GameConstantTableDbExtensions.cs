...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class GameConstantTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IGameConstantTable source, IGameConstantTable otherItem)
        {
            return Equals(source.MaxAccountNameLength, otherItem.MaxAccountNameLength) &&
                   ...
                   Equals(source.ScreenHeight, otherItem.ScreenHeight) && Equals(source.ScreenWidth, otherItem.ScreenWidth) &&
                   Equals(source.ServerIp, otherItem.ServerIp) && Equals(source.ServerPingPort, otherItem.ServerPingPort) &&
