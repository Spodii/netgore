...
/// </returns>
public static System.Boolean HasSameValues(this IQuestTable source, IQuestTable other)
{
return Equals(source.ID, other.ID) && 
Equals(source.Repeatable, other.Repeatable) && 
Equals(source.RewardCash, other.RewardCash) && 
Equals(source.RewardExp, other.RewardExp);
}
