...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class GuildTableDbExtensions
    {
        ...
        /// <summary>
        /// Checks if this <see cref="IGuildTable"/> contains the same values as an<paramref name="other"/> <see cref="IGuildTable"/>.
        /// </summary>
        /// <param name="other">The <see cref="IGuildTable"/> to compare the values to.</param>
        /// <returns>
        /// True if this <see cref="IGuildTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
        /// </returns>
        public static Boolean HasSameValues(this IGuildTable source, IGuildTable other)
        {
            return Equals(source.ID, other.ID) && Equals(source.Name, other.Name) && Equals(source.Tag, other.Tag);
        }
