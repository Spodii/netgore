...
/// </returns>
public static System.Boolean HasSameValues(this ICharacterTemplateInventoryTable source, ICharacterTemplateInventoryTable other)
{
...
Equals(source.Max, other.Max) && 
Equals(source.Min, other.Min);
}
