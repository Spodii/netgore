...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterTemplateInventoryTableDbExtensions
    {
        ...
        /// <summary>
        /// Checks if this <see cref="ICharacterTemplateInventoryTable"/> contains the same values as an<paramref name="other"/> <see cref="ICharacterTemplateInventoryTable"/>.
        /// </summary>
        /// <param name="other">The <see cref="ICharacterTemplateInventoryTable"/> to compare the values to.</param>
        /// <returns>
        /// True if this <see cref="ICharacterTemplateInventoryTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
        /// </returns>
        public static Boolean HasSameValues(this ICharacterTemplateInventoryTable source, ICharacterTemplateInventoryTable other)
        {
            return Equals(source.Chance, other.Chance) && Equals(source.CharacterTemplateID, other.CharacterTemplateID) &&
                   ...
                   Equals(source.Max, other.Max) && Equals(source.Min, other.Min);
        }
