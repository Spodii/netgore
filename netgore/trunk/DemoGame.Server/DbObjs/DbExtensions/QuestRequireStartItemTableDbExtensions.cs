...
/// <summary>
/// Checks if this <see cref="IQuestRequireStartItemTable"/> contains the same values as an<paramref name="other"/> <see cref="IQuestRequireStartItemTable"/>.
/// </summary>
/// <param name="other">The <see cref="IQuestRequireStartItemTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="IQuestRequireStartItemTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
/// </returns>
public static System.Boolean HasSameValues(this IQuestRequireStartItemTable source, IQuestRequireStartItemTable other)
{
