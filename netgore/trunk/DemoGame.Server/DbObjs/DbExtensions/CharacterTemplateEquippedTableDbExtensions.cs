...
source.Chance = (DemoGame.Server.ItemChance)(DemoGame.Server.ItemChance)dataReader.GetUInt16(i);
...
source.ItemTemplateID = (DemoGame.Server.ItemTemplateID)(DemoGame.Server.ItemTemplateID)dataReader.GetUInt16(i);
}
