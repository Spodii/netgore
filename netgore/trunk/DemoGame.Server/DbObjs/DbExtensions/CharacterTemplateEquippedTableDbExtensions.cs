...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterTemplateEquippedTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this ICharacterTemplateEquippedTable source, ICharacterTemplateEquippedTable other)
        {
            return Equals(source.Chance, other.Chance) && Equals(source.CharacterTemplateID, other.CharacterTemplateID) &&
                   Equals(source.ID, other.ID) && Equals(source.ItemTemplateID, other.ItemTemplateID);
        }
        ...
        public static void ReadValues(this CharacterTemplateEquippedTable source, IDataReader dataReader)
        {
            Int32 i;
        ...
        /// <param name="source">The object to add the extension method to.</param>
        /// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
        public static void TryReadValues(this CharacterTemplateEquippedTable source, IDataReader dataReader)
        {
