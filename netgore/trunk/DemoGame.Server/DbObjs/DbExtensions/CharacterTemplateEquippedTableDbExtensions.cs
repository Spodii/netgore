...
public static void ReadValues(this CharacterTemplateEquippedTable source, System.Data.IDataReader dataReader)
{
System.Int32 i;
...
/// <param name="source">The object to add the extension method to.</param>
/// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
public static void TryReadValues(this CharacterTemplateEquippedTable source, System.Data.IDataReader dataReader)
{
...
/// <summary>
/// Checks if this <see cref="ICharacterTemplateEquippedTable"/> contains the same values as an<paramref name="other"/> <see cref="ICharacterTemplateEquippedTable"/>.
/// </summary>
/// <param name="other">The <see cref="ICharacterTemplateEquippedTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="ICharacterTemplateEquippedTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
/// </returns>
public static System.Boolean HasSameValues(this ICharacterTemplateEquippedTable source, ICharacterTemplateEquippedTable other)
{
return Equals(source.Chance, other.Chance) && 
