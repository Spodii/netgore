...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class QuestRequireKillTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IQuestRequireKillTable source, IQuestRequireKillTable otherItem)
        {
        ...
        public static void TryReadValues(this QuestRequireKillTable source, IDataRecord dataRecord)
        {
