...
/// <summary>
/// Checks if this <see cref="IQuestRequireKillTable"/> contains the same values as an<paramref name="other"/> <see cref="IQuestRequireKillTable"/>.
/// </summary>
/// <param name="other">The <see cref="IQuestRequireKillTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="IQuestRequireKillTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
/// </returns>
public static System.Boolean HasSameValues(this IQuestRequireKillTable source, IQuestRequireKillTable other)
{
