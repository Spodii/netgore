...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class WorldStatsCountItemSellTableDbExtensions
    {
        ...
        public static void ReadValues(this WorldStatsCountItemSellTable source, IDataRecord dataRecord)
        {
            Int32 i;
        ...
        public static void TryReadValues(this WorldStatsCountItemSellTable source, IDataRecord dataRecord)
        {
