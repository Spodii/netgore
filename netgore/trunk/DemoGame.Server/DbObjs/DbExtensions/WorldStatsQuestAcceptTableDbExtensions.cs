...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class WorldStatsQuestAcceptTableDbExtensions
    {
        ...
        public static void ReadValues(this WorldStatsQuestAcceptTable source, IDataRecord dataRecord)
        {
            Int32 i;
        ...
        public static void TryReadValues(this WorldStatsQuestAcceptTable source, IDataRecord dataRecord)
        {
