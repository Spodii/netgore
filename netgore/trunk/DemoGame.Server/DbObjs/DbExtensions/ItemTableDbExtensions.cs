...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class ItemTableDbExtensions
    {
        ...
        public static void ReadValues(this ItemTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.ID = (ItemID)dataRecord.GetInt32(i);
        ...
        public static void TryReadValues(this ItemTable source, IDataRecord dataRecord)
        {
