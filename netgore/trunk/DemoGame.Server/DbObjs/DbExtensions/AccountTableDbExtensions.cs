...
/// </returns>
public static System.Boolean HasSameValues(this IAccountTable source, IAccountTable other)
{
return Equals(source.CreatorIp, other.CreatorIp) && 
Equals(source.CurrentIp, other.CurrentIp) && 
Equals(source.Email, other.Email) && 
Equals(source.ID, other.ID) && 
Equals(source.Name, other.Name) && 
Equals(source.Password, other.Password) && 
Equals(source.TimeCreated, other.TimeCreated) && 
