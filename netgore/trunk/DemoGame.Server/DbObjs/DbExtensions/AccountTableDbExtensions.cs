...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AccountTableDbExtensions
    {
        ...
        /// <summary>
        /// Checks if this <see cref="IAccountTable"/> contains the same values as an<paramref name="other"/> <see cref="IAccountTable"/>.
        /// </summary>
        /// <param name="other">The <see cref="IAccountTable"/> to compare the values to.</param>
        /// <returns>
        /// True if this <see cref="IAccountTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
        /// </returns>
        public static Boolean HasSameValues(this IAccountTable source, IAccountTable other)
        {
            return Equals(source.CreatorIp, other.CreatorIp) && Equals(source.CurrentIp, other.CurrentIp) &&
                   Equals(source.Email, other.Email) && Equals(source.ID, other.ID) && Equals(source.Name, other.Name) &&
                   Equals(source.Password, other.Password) && Equals(source.TimeCreated, other.TimeCreated) &&
                   Equals(source.TimeLastLogin, other.TimeLastLogin);
        }
