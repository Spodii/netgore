...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class MapTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IMapTable source, IMapTable otherItem)
        {
        ...
        public static void TryReadValues(this MapTable source, IDataRecord dataRecord)
        {
