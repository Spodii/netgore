...
public static void ReadValues(this CharacterQuestStatusKillsTable source, System.Data.IDataReader dataReader)
{
System.Int32 i;
...
source.Count = (System.UInt16)(System.UInt16)dataReader.GetUInt16(i);
...
/// <param name="source">The object to add the extension method to.</param>
/// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
public static void TryReadValues(this CharacterQuestStatusKillsTable source, System.Data.IDataReader dataReader)
{
...
/// <summary>
/// Checks if this <see cref="ICharacterQuestStatusKillsTable"/> contains the same values as an<paramref name="other"/> <see cref="ICharacterQuestStatusKillsTable"/>.
/// </summary>
/// <param name="other">The <see cref="ICharacterQuestStatusKillsTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="ICharacterQuestStatusKillsTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
/// </returns>
public static System.Boolean HasSameValues(this ICharacterQuestStatusKillsTable source, ICharacterQuestStatusKillsTable other)
{
return Equals(source.CharacterID, other.CharacterID) && 
Equals(source.CharacterTemplateID, other.CharacterTemplateID) && 
Equals(source.Count, other.Count) && 
