...
public static void ReadValues(this CharacterEquippedTable source, System.Data.IDataReader dataReader)
{
System.Int32 i;
...
source.Slot = (DemoGame.EquipmentSlot)(DemoGame.EquipmentSlot)dataReader.GetByte(i);
}
...
/// <param name="source">The object to add the extension method to.</param>
/// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
public static void TryReadValues(this CharacterEquippedTable source, System.Data.IDataReader dataReader)
{
...
/// <summary>
/// Checks if this <see cref="ICharacterEquippedTable"/> contains the same values as an<paramref name="other"/> <see cref="ICharacterEquippedTable"/>.
/// </summary>
/// <param name="other">The <see cref="ICharacterEquippedTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="ICharacterEquippedTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
/// </returns>
public static System.Boolean HasSameValues(this ICharacterEquippedTable source, ICharacterEquippedTable other)
{
