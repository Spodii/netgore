...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterEquippedTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this ICharacterEquippedTable source, ICharacterEquippedTable other)
        {
            return Equals(source.CharacterID, other.CharacterID) && Equals(source.ItemID, other.ItemID) &&
