...
source.ID = (DemoGame.CharacterID)(DemoGame.CharacterID)dataReader.GetInt32(i);
...
/// </returns>
public static System.Boolean HasSameValues(this ICharacterTable source, ICharacterTable other)
{
return Equals(source.AccountID, other.AccountID) && 
Equals(source.AIID, other.AIID) && 
Equals(source.BodyID, other.BodyID) && 
Equals(source.Cash, other.Cash) && 
Equals(source.CharacterTemplateID, other.CharacterTemplateID) && 
...
Equals(source.MapID, other.MapID) && 
Equals(source.MoveSpeed, other.MoveSpeed) && 
Equals(source.MP, other.MP) && 
Equals(source.Name, other.Name) && 
Equals(source.Permissions, other.Permissions) && 
Equals(source.RespawnMap, other.RespawnMap) && 
Equals(source.RespawnX, other.RespawnX) && 
Equals(source.RespawnY, other.RespawnY) && 
