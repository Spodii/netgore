...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class ViewUserCharacterTableDbExtensions
    {
        ...
        public static void ReadValues(this ViewUserCharacterTable source, IDataRecord dataRecord)
        {
            Int32 i;
        ...
        public static void TryReadValues(this ViewUserCharacterTable source, IDataRecord dataRecord)
        {
