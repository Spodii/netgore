...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class ViewUserCharacterTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IViewUserCharacterTable source, IViewUserCharacterTable otherItem)
        {
        ...
        public static void ReadValues(this ViewUserCharacterTable source, IDataReader dataReader)
        {
            Int32 i;
        ...
        /// <param name="source">The object to copy the values from.</param>
        /// <param name="paramValues">The DbParameterValues to copy the values into.</param>
        public static void TryCopyValues(this IViewUserCharacterTable source, DbParameterValues paramValues)
        {
        ...
        /// <param name="source">The object to add the extension method to.</param>
        /// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
        public static void TryReadValues(this ViewUserCharacterTable source, IDataReader dataReader)
        {
