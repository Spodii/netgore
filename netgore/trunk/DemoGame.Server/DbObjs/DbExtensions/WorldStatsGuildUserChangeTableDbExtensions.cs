...
public static void ReadValues(this WorldStatsGuildUserChangeTable source, System.Data.IDataReader dataReader)
{
System.Int32 i;

i = dataReader.GetOrdinal("guild_id");

source.GuildID = (System.Nullable<NetGore.Features.Guilds.GuildID>)(System.Nullable<NetGore.Features.Guilds.GuildID>)(dataReader.IsDBNull(i) ? (System.Nullable<System.UInt16>)null : dataReader.GetUInt16(i));
...
/// <param name="source">The object to add the extension method to.</param>
/// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
public static void TryReadValues(this WorldStatsGuildUserChangeTable source, System.Data.IDataReader dataReader)
{
