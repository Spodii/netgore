...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class WorldStatsGuildUserChangeTableDbExtensions
    {
        ...
        {
            return Equals(source.GuildID, otherItem.GuildID) && Equals(source.UserId, otherItem.UserId) &&
        ...
        public static void ReadValues(this WorldStatsGuildUserChangeTable source, IDataReader dataReader)
        {
            Int32 i;

            i = dataReader.GetOrdinal("guild_id");

            source.GuildID = (Nullable<GuildID>)(dataReader.IsDBNull(i) ? (ushort?)null : dataReader.GetUInt16(i));
        ...
        /// <param name="source">The object to add the extension method to.</param>
        /// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
        public static void TryReadValues(this WorldStatsGuildUserChangeTable source, IDataReader dataReader)
        {
