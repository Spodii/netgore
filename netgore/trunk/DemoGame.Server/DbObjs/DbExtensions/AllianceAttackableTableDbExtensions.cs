...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AllianceAttackableTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IAllianceAttackableTable source, IAllianceAttackableTable other)
        {
            return Equals(source.AllianceID, other.AllianceID) && Equals(source.AttackableID, other.AttackableID);
        }
        ...
        public static void ReadValues(this AllianceAttackableTable source, IDataReader dataReader)
        {
            Int32 i;
            ...
            source.AttackableID = (AllianceID)dataReader.GetByte(i);
        }
        ...
        /// <param name="source">The object to add the extension method to.</param>
        /// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
        public static void TryReadValues(this AllianceAttackableTable source, IDataReader dataReader)
        {
