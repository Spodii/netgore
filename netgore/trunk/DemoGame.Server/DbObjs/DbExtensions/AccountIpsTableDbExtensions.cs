...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AccountIpsTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IAccountIpsTable source, IAccountIpsTable other)
        {
            return Equals(source.AccountID, other.AccountID) && Equals(source.Ip, other.Ip) && Equals(source.Time, other.Time);
        }
