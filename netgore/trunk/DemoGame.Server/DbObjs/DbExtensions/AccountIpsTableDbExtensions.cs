...
/// <summary>
/// Checks if this <see cref="IAccountIpsTable"/> contains the same values as an<paramref name="other"/> <see cref="IAccountIpsTable"/>.
/// </summary>
/// <param name="other">The <see cref="IAccountIpsTable"/> to compare the values to.</param>
/// <returns>
/// True if this <see cref="IAccountIpsTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
/// </returns>
public static System.Boolean HasSameValues(this IAccountIpsTable source, IAccountIpsTable other)
{
return Equals(source.AccountID, other.AccountID) && 
Equals(source.Ip, other.Ip) && 
Equals(source.Time, other.Time);
}
