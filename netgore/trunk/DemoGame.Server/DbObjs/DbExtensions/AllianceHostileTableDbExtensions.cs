...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AllianceHostileTableDbExtensions
    {
        ...
        public static void ReadValues(this AllianceHostileTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.HostileID = (AllianceID)dataRecord.GetByte(i);
        }
        ...
        public static void TryReadValues(this AllianceHostileTable source, IDataRecord dataRecord)
        {
