...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AllianceHostileTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IAllianceHostileTable source, IAllianceHostileTable other)
        {
            return Equals(source.AllianceID, other.AllianceID) && Equals(source.HostileID, other.HostileID);
        }
