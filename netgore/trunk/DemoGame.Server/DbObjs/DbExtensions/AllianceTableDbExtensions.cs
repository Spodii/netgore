...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AllianceTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IAllianceTable source, IAllianceTable otherItem)
        {
            return Equals(source.ID, otherItem.ID) && Equals(source.Name, otherItem.Name);
        }
