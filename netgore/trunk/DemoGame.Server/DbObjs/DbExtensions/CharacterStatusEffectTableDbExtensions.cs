...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterStatusEffectTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this ICharacterStatusEffectTable source, ICharacterStatusEffectTable other)
        {
            return Equals(source.CharacterID, other.CharacterID) && Equals(source.ID, other.ID) &&
                   Equals(source.Power, other.Power) && Equals(source.StatusEffect, other.StatusEffect) &&
