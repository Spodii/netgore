...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class EventCountersGuildTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IEventCountersGuildTable source, IEventCountersGuildTable otherItem)
        {
            return Equals(source.Counter, otherItem.Counter) && Equals(source.GuildEventCounterId, otherItem.GuildEventCounterId) &&
        ...
        public static void ReadValues(this EventCountersGuildTable source, IDataRecord dataRecord)
        {
            Int32 i;
            ...
            source.GuildEventCounterId = dataRecord.GetByte(i);
        ...
        public static void TryReadValues(this EventCountersGuildTable source, IDataRecord dataRecord)
        {
