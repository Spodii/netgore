...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class WorldStatsCountUserKillNpcTableDbExtensions
    {
        ...
        /// </returns>
        public static Boolean HasSameValues(this IWorldStatsCountUserKillNpcTable source,
        ...
        public static void ReadValues(this WorldStatsCountUserKillNpcTable source, IDataReader dataReader)
        {
            Int32 i;
            ...
            source.NpcTemplateId = (CharacterTemplateID)dataReader.GetUInt16(i);
        ...
        /// <param name="source">The object to add the extension method to.</param>
        /// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
        public static void TryReadValues(this WorldStatsCountUserKillNpcTable source, IDataReader dataReader)
        {
