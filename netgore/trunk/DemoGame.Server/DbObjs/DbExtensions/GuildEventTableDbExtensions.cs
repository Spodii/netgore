...
/// </returns>
public static System.Boolean HasSameValues(this IGuildEventTable source, IGuildEventTable other)
{
return Equals(source.Arg0, other.Arg0) && 
Equals(source.Arg1, other.Arg1) && 
Equals(source.Arg2, other.Arg2) && 
Equals(source.CharacterID, other.CharacterID) && 
Equals(source.Created, other.Created) && 
Equals(source.EventID, other.EventID) && 
Equals(source.GuildID, other.GuildID) && 
