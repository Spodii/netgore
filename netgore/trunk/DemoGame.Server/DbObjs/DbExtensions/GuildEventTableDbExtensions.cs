...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class GuildEventTableDbExtensions
    {
        ...
        /// <summary>
        /// Checks if this <see cref="IGuildEventTable"/> contains the same values as an<paramref name="other"/> <see cref="IGuildEventTable"/>.
        /// </summary>
        /// <param name="other">The <see cref="IGuildEventTable"/> to compare the values to.</param>
        /// <returns>
        /// True if this <see cref="IGuildEventTable"/> contains the same values as the <paramref name="<paramref name="other"/>"/>; <paramref name="other"/>wise false.
        /// </returns>
        public static Boolean HasSameValues(this IGuildEventTable source, IGuildEventTable other)
        {
            return Equals(source.Arg0, other.Arg0) && Equals(source.Arg1, other.Arg1) && Equals(source.Arg2, other.Arg2) &&
                   Equals(source.CharacterID, other.CharacterID) && Equals(source.Created, other.Created) &&
                   Equals(source.EventID, other.EventID) && Equals(source.GuildID, other.GuildID) && Equals(source.ID, other.ID) &&
                   Equals(source.TargetCharacterID, other.TargetCharacterID);
        }
