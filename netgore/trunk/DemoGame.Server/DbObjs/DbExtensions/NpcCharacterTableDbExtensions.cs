...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class NpcCharacterTableDbExtensions
    {
        ...
        public static void CopyValues(this INpcCharacterTable source, DbParameterValues paramValues)
        {
            ...
            paramValues["@permissions"] = source.Permissions;
        ...
        /// </returns>
        public static Boolean HasSameValues(this INpcCharacterTable source, INpcCharacterTable otherItem)
        {
            return Equals(source.AccountID, otherItem.AccountID) && Equals(source.AIID, otherItem.AIID) &&
                   ...
                   Equals(source.StatAgi, otherItem.StatAgi) && Equals(source.StatDefence, otherItem.StatDefence) &&
                   Equals(source.StatInt, otherItem.StatInt) && Equals(source.StatMaxhit, otherItem.StatMaxhit) &&
                   Equals(source.StatMaxhp, otherItem.StatMaxhp) && Equals(source.StatMaxmp, otherItem.StatMaxmp) &&
                   Equals(source.StatMinhit, otherItem.StatMinhit) && Equals(source.StatStr, otherItem.StatStr);
        }
        ...
        public static void ReadValues(this NpcCharacterTable source, IDataReader dataReader)
        {
            ...
            source.Permissions = dataReader.GetByte(i);
        ...
        public static void TryCopyValues(this INpcCharacterTable source, DbParameterValues paramValues)
        {
            for (var i = 0; i < paramValues.Count; i++)
            {
                switch (paramValues.GetParameterName(i))
                {
                    ...
                    case "@permissions":
                        paramValues[i] = source.Permissions;
                        break;
