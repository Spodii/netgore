    ...
    public class QuestTable : IQuestTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "repeatable":
                    return new ColumnMetadata("repeatable",
                        "If this quest can be repeated by a character after they have completed it.", "tinyint(1) unsigned", "0",
                        typeof(Boolean), false, false, false);

                case "reward_cash":
                    return new ColumnMetadata("reward_cash", "The base cash reward for completing this quest.", "int(11)", "0",
                        typeof(Int32), false, false, false);

                case "reward_exp":
                    return new ColumnMetadata("reward_exp", "The base experience reward for completing this quest.", "int(11)",
