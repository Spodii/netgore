...
/// </summary>
public DemoGame.Server.ShopID ID
{
get
{
return (DemoGame.Server.ShopID)_iD;
}
set
{
...
public ShopTable(System.Boolean @canBuy, DemoGame.Server.ShopID @iD, System.String @name)
{
this.CanBuy = (System.Boolean)@canBuy;
this.ID = (DemoGame.Server.ShopID)@iD;
...
dic["@id"] = (DemoGame.Server.ShopID)source.ID;
...
this.ID = (DemoGame.Server.ShopID)source.ID;
...
case "id":
this.ID = (DemoGame.Server.ShopID)value;
break;
...
{
case "can_buy":
return new ColumnMetadata("can_buy", "", "tinyint(1)", null, typeof(System.Boolean), false, false, false);

case "id":
return new ColumnMetadata("id", "", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);

case "name":
return new ColumnMetadata("name", "", "varchar(60)", null, typeof(System.String), false, false, false);
