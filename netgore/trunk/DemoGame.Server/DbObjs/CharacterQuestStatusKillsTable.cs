...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterQuestStatusKillsTable : ICharacterQuestStatusKillsTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "character_id":
                    return new ColumnMetadata("character_id", "The character who is doing this quest.", "int(11)", null,
                        typeof(Int32), false, true, false);

                case "character_template_id":
                    return new ColumnMetadata("character_template_id",
                        "The character template that is to be killed for the quest.", "smallint(5) unsigned", null, typeof(UInt16),
                        false, true, false);

                case "count":
                    return new ColumnMetadata("count", "The current kill count of characters with this template.",
                        "smallint(5) unsigned", null, typeof(UInt16), false, false, false);

                case "quest_id":
                    return new ColumnMetadata("quest_id", "The quest that the kill count is for.", "smallint(5) unsigned", null,
