...
/// "The unique ban ID.".
/// </summary>
[System.ComponentModel.Description("The unique ban ID.")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("Name of the person or system that issued this ban.")]
[NetGore.SyncValueAttribute()]
...
case "id":
return new ColumnMetadata("id", "The unique ban ID.", "int(11)", null, typeof(System.Int32), false, true, false);

case "issued_by":
return new ColumnMetadata("issued_by", "Name of the person or system that issued this ban.", "varchar(255)", null, typeof(System.String), true, false, false);
