...
/// </summary>
public class NpcCharacterTable : INpcCharacterTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </returns>
public virtual INpcCharacterTable DeepCopy()
{
return new NpcCharacterTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="NpcCharacterTable"/> class.
/// </summary>
...
case "load_map_id":
return new ColumnMetadata("load_map_id", "", "smallint(5) unsigned", "1", typeof(System.UInt16), false, false, false);
...
case "respawn_map_id":
return new ColumnMetadata("respawn_map_id", "", "smallint(5) unsigned", "1", typeof(System.Nullable<System.UInt16>), true, false, false);
