...
namespace DemoGame.Server.DbObjs
{
    ...
    public class GuildTable : IGuildTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "created":
                    return new ColumnMetadata("created", "When this guild was created.", "timestamp", "CURRENT_TIMESTAMP",
                        typeof(DateTime), false, false, false);

                case "id":
                    return new ColumnMetadata("id", "The unique ID of the guild.", "smallint(5) unsigned", null, typeof(UInt16),
                        false, true, false);

                case "name":
                    return new ColumnMetadata("name", "The name of the guild.", "varchar(50)", null, typeof(String), false, false,
                        false);

                case "tag":
                    return new ColumnMetadata("tag", "The guild's tag.", "varchar(5)", null, typeof(String), false, false, false);
