...
{
case "count":
return new ColumnMetadata("count", "", "int(11)", "0", typeof(System.Int32), false, false, false);

case "last_update":
return new ColumnMetadata("last_update", "", "timestamp", "0000-00-00 00:00:00", typeof(System.DateTime), false, false, false);

case "npc_template_id":
return new ColumnMetadata("npc_template_id", "", "smallint(5) unsigned", null, typeof(System.UInt16), false, true, false);

case "user_id":
return new ColumnMetadata("user_id", "", "int(11)", null, typeof(System.Int32), false, true, false);
