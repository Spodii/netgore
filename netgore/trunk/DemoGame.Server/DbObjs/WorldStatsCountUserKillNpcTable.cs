...
namespace DemoGame.Server.DbObjs
{
    ...
    public class WorldStatsCountUserKillNpcTable : IWorldStatsCountUserKillNpcTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "count":
                    return new ColumnMetadata("count", "Total number of NPCs killed by this user.", "int(11)", "0", typeof(Int32),
                        false, false, false);
                ...
                case "npc_template_id":
                    return new ColumnMetadata("npc_template_id", "The character template that this NPC kill counter is for.",
                        "smallint(5) unsigned", null, typeof(UInt16), false, true, false);

                case "user_id":
                    return new ColumnMetadata("user_id", "The user that this kill counter is for.", "int(11)", null, typeof(Int32),
                        false, true, false);
