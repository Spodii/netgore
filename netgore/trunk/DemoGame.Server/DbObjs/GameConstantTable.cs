...
/// </returns>
public virtual IGameConstantTable DeepCopy()
{
return new GameConstantTable(this);
}
/// <summary>
/// Initializes a new instance of the <see cref="GameConstantTable"/> class.
/// </summary>
...
case "server_ip":
return new ColumnMetadata("server_ip", "", "varchar(150)", null, typeof(System.String), false, false, false);
