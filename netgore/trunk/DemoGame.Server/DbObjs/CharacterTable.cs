...
/// </summary>
 static  readonly System.String[] _dbColumns = new string[] {"account_id", "ai_id", "body_id", "cash", "character_template_id", "chat_dialog", "exp", "hp", "id", "level", "load_map_id", "load_x", "load_y", "move_speed", "mp", "name", "permissions", "respawn_map_id", "respawn_x", "respawn_y", "shop_id", "statpoints", "stat_agi", "stat_defence", "stat_int", "stat_maxhit", "stat_maxhp", "stat_maxmp", "stat_minhit", "stat_str" };
/// <summary>
...
/// </summary>
[NetGore.SyncValueAttribute()]
public NetGore.MapID LoadMapID
{
get
{
return (NetGore.MapID)_loadMapID;
}
set
{
...
/// The underlying database type is `smallint(5) unsigned` with the default value of `100`.
/// </summary>
[NetGore.SyncValueAttribute()]
...
/// </summary>
[NetGore.SyncValueAttribute()]
public System.Nullable<NetGore.MapID> RespawnMapID
{
get
{
return (System.Nullable<NetGore.MapID>)_respawnMapID;
}
set
{
...
public CharacterTable(System.Nullable<DemoGame.AccountID> @accountID, System.Nullable<NetGore.AI.AIID> @aIID, DemoGame.BodyID @bodyID, System.Int32 @cash, System.Nullable<DemoGame.CharacterTemplateID> @characterTemplateID, System.Nullable<NetGore.NPCChat.NPCChatDialogID> @chatDialog, System.Int32 @exp, DemoGame.SPValueType @hP, DemoGame.CharacterID @iD, System.Byte @level, NetGore.MapID @loadMapID, System.UInt16 @loadX, System.UInt16 @loadY, System.UInt16 @moveSpeed, DemoGame.SPValueType @mP, System.String @name, DemoGame.UserPermissions @permissions, System.Nullable<NetGore.MapID> @respawnMapID, System.Single @respawnX, System.Single @respawnY, System.Nullable<NetGore.Features.Shops.ShopID> @shopID, System.Int32 @statPoints, System.Int16 @statAgi, System.Int16 @statDefence, System.Int16 @statInt, System.Int16 @statMaxhit, System.Int16 @statMaxhp, System.Int16 @statMaxmp, System.Int16 @statMinhit, System.Int16 @statStr)
{
...
this.LoadMapID = (NetGore.MapID)@loadMapID;
...
this.RespawnMapID = (System.Nullable<NetGore.MapID>)@respawnMapID;
...
dic["@load_map_id"] = (NetGore.MapID)source.LoadMapID;
...
dic["@respawn_map_id"] = (System.Nullable<NetGore.MapID>)source.RespawnMapID;
...
this.LoadMapID = (NetGore.MapID)source.LoadMapID;
...
this.RespawnMapID = (System.Nullable<NetGore.MapID>)source.RespawnMapID;
...
case "load_map_id":
this.LoadMapID = (NetGore.MapID)value;
break;
...
case "respawn_map_id":
this.RespawnMapID = (System.Nullable<NetGore.MapID>)value;
break;
...
case "load_map_id":
return new ColumnMetadata("load_map_id", "", "smallint(5) unsigned", "1", typeof(System.UInt16), false, false, true);

case "load_x":
return new ColumnMetadata("load_x", "", "smallint(5) unsigned", "100", typeof(System.UInt16), false, false, false);

case "load_y":
return new ColumnMetadata("load_y", "", "smallint(5) unsigned", "100", typeof(System.UInt16), false, false, false);
...
case "permissions":
return new ColumnMetadata("permissions", "", "tinyint(3) unsigned", "0", typeof(System.Byte), false, false, false);

case "respawn_map_id":
return new ColumnMetadata("respawn_map_id", "", "smallint(5) unsigned", null, typeof(System.Nullable<System.UInt16>), true, false, true);
