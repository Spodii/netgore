...
case "load_x":
return new ColumnMetadata("load_x", "", "smallint(5) unsigned", "50", typeof(System.UInt16), false, false, false);

case "load_y":
return new ColumnMetadata("load_y", "", "smallint(5) unsigned", "50", typeof(System.UInt16), false, false, false);
...
case "respawn_map_id":
return new ColumnMetadata("respawn_map_id", "", "smallint(5) unsigned", "1", typeof(System.Nullable<System.UInt16>), true, false, true);
