...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTable : ICharacterTable, IPersistable
    {
        ...
        static readonly String[] _dbColumns = new string[]
        {
            ...
            "move_speed", "mp", "name", "respawn_map", "respawn_x", "respawn_y", "shop_id", "statpoints", "stat_agi", "stat_defence"
            , "stat_int", "stat_maxhit", "stat_maxhp", "stat_maxmp", "stat_minhit", "stat_str", "x", "y"
        };
