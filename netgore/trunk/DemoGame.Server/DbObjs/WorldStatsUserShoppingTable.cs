    ...
    public class WorldStatsUserShoppingTable : IWorldStatsUserShoppingTable, IPersistable
    {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "x":
                    return new ColumnMetadata("x", "The map X coordinate of the shopper when this event took place.",
                                              "smallint(5) unsigned", null, typeof(UInt16), false, false, false);

                case "y":
                    return new ColumnMetadata("y", "The map Y coordinate of the shopper when this event took place.",
                                              "smallint(5) unsigned", null, typeof(UInt16), false, false, false);
        ...
        /// </summary>
        [Description("The map X coordinate of the shopper when this event took place.")]
        [SyncValue]
        public UInt16 X
        {
            get { return _x; }
        ...
        /// </summary>
        [Description("The map Y coordinate of the shopper when this event took place.")]
        [SyncValue]
        public UInt16 Y
        {
            get { return _y; }
