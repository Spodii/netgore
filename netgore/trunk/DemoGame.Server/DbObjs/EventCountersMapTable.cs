        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "map_event_counter_id":
                    return new ColumnMetadata("map_event_counter_id", "The ID of the event that the counter is for.",
                        "tinyint(3) unsigned", null, typeof(Byte), false, true, false);

                case "map_id":
                    return new ColumnMetadata("map_id", "The map the event occured on.", "smallint(5) unsigned", null,
