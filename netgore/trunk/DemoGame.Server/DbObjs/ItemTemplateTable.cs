...
namespace DemoGame.Server.DbObjs
{
    ...
    public class ItemTemplateTable : IItemTemplateTable, IPersistable
    {
        ...
        {
            "description", "equipped_body", "graphic", "height", "hp", "id", "mp", "name", "stat_agi", "stat_defence", "stat_int",
        ...
        {
            "description", "equipped_body", "graphic", "height", "hp", "mp", "name", "stat_agi", "stat_defence", "stat_int",
            "stat_maxhit", "stat_maxhp", "stat_maxmp", "stat_minhit", "stat_req_agi", "stat_req_int", "stat_req_str", "stat_str",
            "type", "value", "width"
        };
        ...
        public ItemTemplateTable(String @description, String @equippedBody, GrhIndex @graphic, Byte @height, SPValueType @hP,
                                 ItemTemplateID @iD, SPValueType @mP, String @name, Int16 @statAgi, Int16 @statDefence,
                                 Int16 @statInt, Int16 @statMaxhit, Int16 @statMaxhp, Int16 @statMaxmp, Int16 @statMinhit,
                                 Int16 @statReqAgi, Int16 @statReqInt, Int16 @statReqStr, Int16 @statStr, Byte @type, Int32 @value,
                                 Byte @width)
        {
