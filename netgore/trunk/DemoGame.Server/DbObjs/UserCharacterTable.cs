...
namespace DemoGame.Server.DbObjs
{
    ...
    public class UserCharacterTable : IUserCharacterTable, IPersistable
    {
        ...
        public UserCharacterTable(AccountID? @accountID, AIID? @aIID, BodyID @bodyID, Int32 @cash,
                                  CharacterTemplateID? @characterTemplateID, NPCChatDialogID? @chatDialog, Int32 @exp,
                                  SPValueType @hP, Int32 @iD, Byte @level, MapID @loadMapID, UInt16 @loadX, UInt16 @loadY,
                                  UInt16 @moveSpeed, SPValueType @mP, String @name, Byte @permissions, MapID? @respawnMapID,
                                  ...
                                  Int16 @statMinhit, Int16 @statStr)
        {
            AccountID = @accountID;
            AIID = @aIID;
            BodyID = @bodyID;
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "load_x":
                    return new ColumnMetadata("load_x", "", "smallint(5) unsigned", "100", typeof(UInt16), false, false, false);

                case "load_y":
                    return new ColumnMetadata("load_y", "", "smallint(5) unsigned", "100", typeof(UInt16), false, false, false);
                ...
                case "respawn_map_id":
                    return new ColumnMetadata("respawn_map_id", "", "smallint(5) unsigned", null, typeof(ushort?), true, false,
                                              false);
