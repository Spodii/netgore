...
{
/// <summary>
/// Provides a strongly-typed structure for the database table `world_stats_guild_create`.
/// </summary>
public class WorldStatsGuildCreateTable : IWorldStatsGuildCreateTable, NetGore.IO.IPersistable
{
/// <summary>
...
/// </summary>
public const System.String TableName = "world_stats_guild_create";
/// <summary>
...
/// "The ID of the guild that was created.".
/// </summary>
[System.ComponentModel.Description("The ID of the guild that was created.")]
...
/// "The ID of the user that created the guild.".
/// </summary>
[System.ComponentModel.Description("The ID of the user that created the guild.")]
[NetGore.SyncValueAttribute()]
...
/// </returns>
public IWorldStatsGuildCreateTable DeepCopy()
{
return new WorldStatsGuildCreateTable(this);
}
/// <summary>
/// WorldStatsGuildCreateTable constructor.
/// </summary>
public WorldStatsGuildCreateTable()
{
}
/// <summary>
/// WorldStatsGuildCreateTable constructor.
...
public WorldStatsGuildCreateTable(NetGore.Features.Guilds.GuildID @guildID, DemoGame.CharacterID @userId, System.DateTime @when)
{
...
/// WorldStatsGuildCreateTable constructor.
/// </summary>
/// <param name="source">IWorldStatsGuildCreateTable to copy the initial values from.</param>
public WorldStatsGuildCreateTable(IWorldStatsGuildCreateTable source)
{
...
/// <param name="dic">The Dictionary to copy the values into.</param>
public static void CopyValues(IWorldStatsGuildCreateTable source, System.Collections.Generic.IDictionary<System.String,System.Object> dic)
{
...
/// <summary>
/// Copies the values from the given <paramref name="source"/> into this WorldStatsGuildCreateTable.
/// </summary>
/// <param name="source">The IWorldStatsGuildCreateTable to copy the values from.</param>
public void CopyValuesFrom(IWorldStatsGuildCreateTable source)
{
...
{
case "guild_id":
return new ColumnMetadata("guild_id", "The ID of the guild that was created.", "smallint(5) unsigned", null, typeof(System.UInt16), false, false, true);

case "user_id":
return new ColumnMetadata("user_id", "The ID of the user that created the guild.", "int(11)", null, typeof(System.Int32), false, false, true);
