...
namespace DemoGame.Server.DbObjs
{
    ...
    /// </summary>
    public class WorldStatsUserKillNpcTable : IWorldStatsUserKillNpcTable, IPersistable
    {
        /// <summary>
        ...
        /// </summary>
        public const String TableName = "world_stats_user_kill_npc";
        ...
        /// <summary>
        /// WorldStatsUserKillNpcTable constructor.
        /// </summary>
        ...
        public WorldStatsUserKillNpcTable(MapID @mapID, CharacterTemplateID? @npcTemplateId, UInt16 @npcX, UInt16 @npcY,
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "npc_x":
                    return new ColumnMetadata("npc_x", "The map x coordinate of the NPC when this event took place.",
                                              "smallint(5) unsigned", null, typeof(UInt16), false, false, false);

                case "npc_y":
                    return new ColumnMetadata("npc_y", "The map y coordinate of the NPC when this event took place.",
                                              "smallint(5) unsigned", null, typeof(UInt16), false, false, false);
        ...
        #region IWorldStatsUserKillNpcTable Members
        ...
        /// </summary>
        [Description("The map x coordinate of the NPC when this event took place.")]
        [SyncValue]
        public UInt16 NpcX
        {
            get { return _npcX; }
        ...
        /// </summary>
        [Description("The map y coordinate of the NPC when this event took place.")]
        [SyncValue]
        public UInt16 NpcY
        {
            get { return _npcY; }
        ...
        /// </returns>
        public IWorldStatsUserKillNpcTable DeepCopy()
        {
