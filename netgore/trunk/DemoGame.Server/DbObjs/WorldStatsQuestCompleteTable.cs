...
namespace DemoGame.Server.DbObjs
{
    ...
    /// </summary>
    public class WorldStatsQuestCompleteTable : IWorldStatsQuestCompleteTable, IPersistable
    {
        /// <summary>
        ...
        /// </summary>
        public const String TableName = "world_stats_quest_complete";
        ...
        /// <summary>
        /// WorldStatsQuestCompleteTable constructor.
        /// </summary>
        ...
        public WorldStatsQuestCompleteTable(MapID? @mapID, QuestID @questID, CharacterID @userId, DateTime @when, UInt16 @x,
                                            UInt16 @y)
        {
            MapID = @mapID;
            QuestID = @questID;
        ...
        public static void CopyValues(IWorldStatsQuestCompleteTable source, IDictionary<String, Object> dic)
        {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "quest_id":
                    return new ColumnMetadata("quest_id", "The quest that was completed.", "smallint(5) unsigned", null,
                                              typeof(UInt16), false, false, true);

                case "user_id":
                    return new ColumnMetadata("user_id", "The ID of the user that completed the quest.", "int(11)", null,
        ...
        #region IWorldStatsQuestCompleteTable Members
        ...
        /// </returns>
        public IWorldStatsQuestCompleteTable DeepCopy()
        {
