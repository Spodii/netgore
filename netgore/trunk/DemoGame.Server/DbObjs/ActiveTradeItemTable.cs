...
/// </summary>
[System.ComponentModel.Description("The ID of the character that added the item.")]
...
/// </summary>
[System.ComponentModel.Description("The unique ID of the row.")]
[NetGore.SyncValueAttribute()]
...
{
case "character_id":
return new ColumnMetadata("character_id", "The ID of the character that added the item.", "int(11)", null, typeof(System.Int32), false, false, true);

case "item_id":
return new ColumnMetadata("item_id", "The unique ID of the row.", "int(11)", null, typeof(System.Int32), false, true, false);
