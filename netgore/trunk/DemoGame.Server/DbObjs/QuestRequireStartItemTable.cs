...
namespace DemoGame.Server.DbObjs
{
    ...
    /// </summary>
    public class QuestRequireStartItemTable : IQuestRequireStartItemTable, IPersistable
    {
        /// <summary>
        ...
        /// </summary>
        public const String TableName = "quest_require_start_item";
        ...
        public QuestRequireStartItemTable(Byte @amount, ItemTemplateID @itemTemplateID, QuestID @questID)
        {
            Amount = @amount;
        ...
        public static void CopyValues(IQuestRequireStartItemTable source, IDictionary<String, Object> dic)
        {
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "amount":
                    return new ColumnMetadata("amount", "The amount of the item that is required.", "tinyint(3) unsigned", null,
                        typeof(Byte), false, false, false);

                case "item_template_id":
                    return new ColumnMetadata("item_template_id", "The template of the item that is required to start the quest.",
                        "smallint(5) unsigned", null, typeof(UInt16), false, true, false);

                case "quest_id":
                    return new ColumnMetadata("quest_id", "Quest that this requirement is for.", "smallint(5) unsigned", null,
        ...
        #region IQuestRequireStartItemTable Members
