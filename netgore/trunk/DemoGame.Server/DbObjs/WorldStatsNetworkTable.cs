...
namespace DemoGame.Server.DbObjs
{
    ...
    public class WorldStatsNetworkTable : IWorldStatsNetworkTable, IPersistable
    {
        ...
        /// </summary>
        public const Int32 ColumnCount = 11;
        ...
        {
            "connections", "id", "tcp_recv", "tcp_recvs", "tcp_sends", "tcp_sent", "udp_recv", "udp_recvs", "udp_sends", "udp_sent",
            "when"
        };
        ...
        public WorldStatsNetworkTable(UInt32 @connections, UInt32 @iD, UInt32 @tcpRecv, UInt32 @tcpRecvs, UInt32 @tcpSends,
                                      UInt32 @tcpSent, UInt32 @udpRecv, UInt32 @udpRecvs, UInt32 @udpSends, UInt32 @udpSent,
                                      DateTime @when)
        {
