...
/// </summary>
[System.ComponentModel.Description("Number of live connections to the server at this time.")]
...
/// </summary>
[System.ComponentModel.Description("The number of bytes that have been received (diff since last snapshot).")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("The number of complete messages that have been received (diff since last snapshot).")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("The number of individual packets received (diff since last snapshot).")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("The number of bytes that have been sent (diff since last snapshot).")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("The number of complete messages that have been sent (diff since last snapshot).")]
[NetGore.SyncValueAttribute()]
...
/// </summary>
[System.ComponentModel.Description("The number of individual packets sent (diff since last snapshot).")]
[NetGore.SyncValueAttribute()]
...
{
case "connections":
return new ColumnMetadata("connections", "Number of live connections to the server at this time.", "smallint(5) unsigned", null, typeof(System.UInt16), false, false, false);

case "id":
return new ColumnMetadata("id", "", "mediumint(8) unsigned", null, typeof(System.UInt32), false, true, false);

case "recv_bytes":
return new ColumnMetadata("recv_bytes", "The number of bytes that have been received (diff since last snapshot).", "mediumint(8) unsigned", null, typeof(System.UInt32), false, false, false);

case "recv_messages":
return new ColumnMetadata("recv_messages", "The number of complete messages that have been received (diff since last snapshot).", "mediumint(8) unsigned", null, typeof(System.UInt32), false, false, false);

case "recv_packets":
return new ColumnMetadata("recv_packets", "The number of individual packets received (diff since last snapshot).", "mediumint(8) unsigned", null, typeof(System.UInt32), false, false, false);

case "sent_bytes":
return new ColumnMetadata("sent_bytes", "The number of bytes that have been sent (diff since last snapshot).", "mediumint(8) unsigned", null, typeof(System.UInt32), false, false, false);

case "sent_messages":
return new ColumnMetadata("sent_messages", "The number of complete messages that have been sent (diff since last snapshot).", "mediumint(8) unsigned", null, typeof(System.UInt32), false, false, false);

case "sent_packets":
return new ColumnMetadata("sent_packets", "The number of individual packets sent (diff since last snapshot).", "mediumint(8) unsigned", null, typeof(System.UInt32), false, false, false);
