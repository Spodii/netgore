...
{
    sealed class NetReliableUnorderedReceiver : NetReceiverChannelBase
    {
        readonly NetBitVector m_earlyReceived;
        readonly int m_windowSize;
        int m_windowStart;

        public NetReliableUnorderedReceiver(NetConnection connection, int windowSize) : base(connection)
        {
