...
{
    sealed class NetReliableOrderedReceiver : NetReceiverChannelBase
    {
        ...
        public NetReliableOrderedReceiver(NetConnection connection, int windowSize) : base(connection)
        {
