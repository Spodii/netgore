...
namespace Lidgren.Network
{
    public partial class NetPeer
    {
        ...
        /// </summary>
        void HandleNatIntroduction(int ptr)
        {
            VerifyNetworkThread();
        ...
        /// </summary>
        void HandleNatPunch(int ptr, IPEndPoint senderEndpoint)
        {
            var tmp = SetupReadHelperMessage(ptr, 1000); // never mind length
        ...
        /// </summary>
        public void Introduce(IPEndPoint hostInternal, IPEndPoint hostExternal, IPEndPoint clientInternal,
                              IPEndPoint clientExternal, string token)
        {
            // send message to client
            var msg = CreateMessage(10 + token.Length + 1);
