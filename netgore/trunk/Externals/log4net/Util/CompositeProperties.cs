...
namespace log4net.Util
{
    ...
    public sealed class CompositeProperties
    {
        ...
        readonly ArrayList m_nestedProperties = new ArrayList();
        PropertiesDictionary m_flattened = null;
        ...
        public PropertiesDictionary Flatten()
        {
            if (m_flattened == null)
            {
                ...
                for (var i = m_nestedProperties.Count; --i >= 0;)
                {
                    var cur = (ReadOnlyPropertiesDictionary)m_nestedProperties[i];
