...
namespace log4net.Util.PatternStringConverters
{
    ...
    class DatePatternConverter : PatternConverter, IOptionHandler
    {
        /// <summary>
        ...
        {
            var dateFormatStr = Option;
            if (dateFormatStr == null)
                dateFormatStr = AbsoluteTimeDateFormatter.Iso8601TimeDateFormat;

            if (
                string.Compare(dateFormatStr, AbsoluteTimeDateFormatter.Iso8601TimeDateFormat, true, CultureInfo.InvariantCulture) ==
                0)
            ...
            else
            {
                ...
                {
                    LogLog.Error(
                        "DatePatternConverter: Could not instantiate SimpleDateFormatter with [" + dateFormatStr + "]", e);
                    m_dateFormatter = new Iso8601DateFormatter();
                }
            }
        }
