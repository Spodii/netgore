...
namespace log4net.Repository
{
    ...
    public abstract class LoggerRepositorySkeleton : ILoggerRepository
    {
        ...
        readonly PluginMap m_pluginMap;
        readonly PropertiesDictionary m_properties;
        ...
        public virtual void Shutdown()
        {
            ...
            foreach (var plugin in PluginMap.AllPlugins)
            {
                plugin.Shutdown();
            }
        ...
        protected virtual void OnConfigurationChanged(EventArgs e)
        {
            ...
            var handler = m_configurationChangedEvent;
            if (handler != null)
        ...
        protected virtual void OnConfigurationReset(EventArgs e)
        {
            ...
            var handler = m_configurationResetEvent;
            if (handler != null)
                handler(this, e);
        }
