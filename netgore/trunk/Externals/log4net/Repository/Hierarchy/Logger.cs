...
namespace log4net.Repository.Hierarchy
{
    ...
    public abstract class Logger : IAppenderAttachable, ILogger
    {
        ...
        public virtual Level EffectiveLevel
        {
            get
            {
                for (var c = this; c != null; c = c.m_parent)
                {
                    var level = c.m_level;
        ...
        public virtual void Log(Type callerStackBoundaryDeclaringType, Level level, object message, Exception exception)
        {
            try
            {
                ...
                {
                    ForcedLog((callerStackBoundaryDeclaringType != null) ? callerStackBoundaryDeclaringType : ThisDeclaringType,
        ...
        public virtual void CloseNestedAppenders()
        {
            ...
            try
            {
                if (m_appenderAttachedImpl != null)
                {
                    var appenders = m_appenderAttachedImpl.Appenders;
        ...
        /// </summary>
        static readonly Type ThisDeclaringType = typeof(Logger);
        ...
        /// </summary>
        readonly ReaderWriterLock m_appenderLock = new ReaderWriterLock();
        ...
        /// </summary>
        AppenderAttachedImpl m_appenderAttachedImpl;
