...
namespace log4net.Appender
{
    ...
    public class AdoNetAppender : BufferingAppenderSkeleton
    {
        ...
        protected override void SendBuffer(LoggingEvent[] events)
        {
            ...
            {
                LogLog.Debug("AdoNetAppender: Attempting to reconnect to database. Current Connection State: " +
        ...
        /// </summary>
        void InitializeDatabaseCommand()
        {
        ...
        protected virtual void SendBuffer(IDbTransaction dbTran, LoggingEvent[] events)
        {
            ...
            else
            {
                ...
                using (var dbCmd = m_dbConnection.CreateCommand())
                {
                    if (dbTran != null)
                    ...
                    foreach (var e in events)
                    {
                        ...
                        var logStatement = GetLogStatement(e);
    ...
    public class AdoNetAppenderParameter
    {
        ...
        public virtual void FormatValue(IDbCommand command, LoggingEvent loggingEvent)
        {
            ...
            var param = (IDbDataParameter)command.Parameters[m_parameterName];
