...
namespace log4net.Config
{
    ...
    public /*sealed*/ class XmlConfiguratorAttribute : ConfiguratorAttribute
    {
        ...
        void ConfigureFromFile(ILoggerRepository targetRepository, FileInfo configFile)
        {
        ...
        string m_configFile = null;
        string m_configFileExtension = null;
        bool m_configureAndWatch = false;
