    ...
    <log4j:data name="log4japp" value="udp-generator"/>
		...
		*/
        ...
        protected override void FormatXml(XmlWriter writer, LoggingEvent loggingEvent)
        {
            ...
            var timeSince1970 = loggingEvent.TimeStamp.ToUniversalTime() - s_date1970;
            ...
            var ndcObj = loggingEvent.LookupProperty("NDC");
            if (ndcObj != null)
            {
                var valueStr = loggingEvent.Repository.RendererMap.FindAndRender(ndcObj);
            ...
            if (properties.Count > 0)
            {
                ...
                foreach (DictionaryEntry entry in properties)
                {
                    ...
                    var valueStr = loggingEvent.Repository.RendererMap.FindAndRender(entry.Value);
