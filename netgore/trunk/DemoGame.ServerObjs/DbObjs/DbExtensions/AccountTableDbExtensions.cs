...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class AccountTableDbExtensions
    {
        ...
        public static void ReadValues(this AccountTable source, IDataReader dataReader)
        {
            ...
            source.CurrentIp = (Nullable<UInt32>)(dataReader.IsDBNull(i) ? (Nullable<UInt32>)null : dataReader.GetUInt32(i));

            i = dataReader.GetOrdinal("email");
            source.Email = (String)dataReader.GetString(i);
            ...
            source.Password = (String)dataReader.GetString(i);

            i = dataReader.GetOrdinal("time_created");
            source.TimeCreated = (DateTime)dataReader.GetDateTime(i);

            i = dataReader.GetOrdinal("time_last_login");
            source.TimeLastLogin = (DateTime)dataReader.GetDateTime(i);
        }
        ...
        public static void TryReadValues(this AccountTable source, IDataReader dataReader)
        {
            for (int i = 0; i < dataReader.FieldCount; i++)
            {
                switch (dataReader.GetName(i))
                {
                    case "current_ip":
                        source.CurrentIp =
                            (Nullable<UInt32>)(dataReader.IsDBNull(i) ? (Nullable<UInt32>)null : dataReader.GetUInt32(i));
                        break;
