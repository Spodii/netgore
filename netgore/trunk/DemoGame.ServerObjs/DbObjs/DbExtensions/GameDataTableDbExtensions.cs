...
public static void CopyValues(this IGameDataTable source, NetGore.Db.DbParameterValues paramValues)
{
...
public static void ReadValues(this GameDataTable source, System.Data.IDataReader dataReader)
{
System.Int32 i;
...
/// <param name="source">The object to add the extension method to.</param>
/// <param name="dataReader">The IDataReader to read the values from. Must already be ready to be read from.</param>
public static void TryReadValues(this GameDataTable source, System.Data.IDataReader dataReader)
{
...
/// <param name="source">The object to copy the values from.</param>
/// <param name="paramValues">The DbParameterValues to copy the values into.</param>
public static void TryCopyValues(this IGameDataTable source, NetGore.Db.DbParameterValues paramValues)
{
