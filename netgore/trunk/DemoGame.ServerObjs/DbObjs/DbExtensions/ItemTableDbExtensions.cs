...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class ItemTableDbExtensions
    {
        ...
        public static void ReadValues(this ItemTable source, IDataReader dataReader)
        {
            ...
            source.SetStat(StatType.Agi, (Int16)dataReader.GetInt16(i));

            i = dataReader.GetOrdinal("amount");
            source.Amount = (Byte)dataReader.GetByte(i);

            i = dataReader.GetOrdinal("armor");
            source.SetStat(StatType.Armor, (UInt16)dataReader.GetUInt16(i));

            i = dataReader.GetOrdinal("bra");
            source.SetStat(StatType.Bra, (Int16)dataReader.GetInt16(i));

            i = dataReader.GetOrdinal("defence");
            source.SetStat(StatType.Defence, (Int16)dataReader.GetInt16(i));

            i = dataReader.GetOrdinal("description");
            source.Description = (String)dataReader.GetString(i);

            i = dataReader.GetOrdinal("dex");
            source.SetStat(StatType.Dex, (Int16)dataReader.GetInt16(i));

            i = dataReader.GetOrdinal("evade");
            source.SetStat(StatType.Evade, (Int16)dataReader.GetInt16(i));

            i = dataReader.GetOrdinal("graphic");
            source.Graphic = (GrhIndex)dataReader.GetUInt16(i);

            i = dataReader.GetOrdinal("height");
            source.Height = (Byte)dataReader.GetByte(i);
            ...
            source.SetStat(StatType.Imm, (Int16)dataReader.GetInt16(i));

            i = dataReader.GetOrdinal("int");
            source.SetStat(StatType.Int, (Int16)dataReader.GetInt16(i));

            i = dataReader.GetOrdinal("maxhit");
            source.SetStat(StatType.MaxHit, (Int16)dataReader.GetInt16(i));
            ...
            source.SetStat(StatType.MinHit, (Int16)dataReader.GetInt16(i));
            ...
            source.SetStat(StatType.Perc, (Int16)dataReader.GetInt16(i));

            i = dataReader.GetOrdinal("reqacc");
            source.SetReqStat(StatType.Acc, (Byte)dataReader.GetByte(i));

            i = dataReader.GetOrdinal("reqagi");
            source.SetReqStat(StatType.Agi, (Byte)dataReader.GetByte(i));

            i = dataReader.GetOrdinal("reqarmor");
            source.SetReqStat(StatType.Armor, (Byte)dataReader.GetByte(i));

            i = dataReader.GetOrdinal("reqbra");
            source.SetReqStat(StatType.Bra, (Byte)dataReader.GetByte(i));

            i = dataReader.GetOrdinal("reqdex");
            source.SetReqStat(StatType.Dex, (Byte)dataReader.GetByte(i));

            i = dataReader.GetOrdinal("reqevade");
            source.SetReqStat(StatType.Evade, (Byte)dataReader.GetByte(i));

            i = dataReader.GetOrdinal("reqimm");
            source.SetReqStat(StatType.Imm, (Byte)dataReader.GetByte(i));

            i = dataReader.GetOrdinal("reqint");
            source.SetReqStat(StatType.Int, (Byte)dataReader.GetByte(i));

            i = dataReader.GetOrdinal("type");
            source.Type = (ItemType)dataReader.GetByte(i);

            i = dataReader.GetOrdinal("value");
            source.Value = (Int32)dataReader.GetInt32(i);

            i = dataReader.GetOrdinal("width");
            source.Width = (Byte)dataReader.GetByte(i);
        }
        ...
        public static void TryCopyValues(this IItemTable source, DbParameterValues paramValues)
        {
            for (int i = 0; i < paramValues.Count; i++)
            {
                switch (paramValues.GetParameterName(i))
                {
                    ...
                    case "@armor":
                        paramValues[i] = (UInt16)source.GetStat(StatType.Armor);
                        break;
