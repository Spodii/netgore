...
namespace DemoGame.Server.DbObjs
{
    ...
    public static class CharacterTemplateTableDbExtensions
    {
        ...
        public static void ReadValues(this CharacterTemplateTable source, IDataReader dataReader)
        {
            ...
            source.AI = (String)dataReader.GetString(i);
            ...
            source.GiveCash = (UInt16)dataReader.GetUInt16(i);

            i = dataReader.GetOrdinal("give_exp");
            source.GiveExp = (UInt16)dataReader.GetUInt16(i);

            i = dataReader.GetOrdinal("id");
            source.ID = (UInt16)dataReader.GetUInt16(i);
            ...
            source.SetStat(StatType.MaxHP, (UInt16)dataReader.GetUInt16(i));

            i = dataReader.GetOrdinal("maxmp");
            source.SetStat(StatType.MaxMP, (UInt16)dataReader.GetUInt16(i));
            ...
            source.Respawn = (UInt16)dataReader.GetUInt16(i);
