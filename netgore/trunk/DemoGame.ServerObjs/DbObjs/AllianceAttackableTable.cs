...
namespace DemoGame.Server.DbObjs
{
    ...
    public class AllianceAttackableTable : IAllianceAttackableTable
    {
        ...
        public AllianceAttackableTable(AllianceID @allianceID, AllianceID @attackableID, Nullable<Byte> @placeholder)
        {
            AllianceID = (AllianceID)@allianceID;
            AttackableID = (AllianceID)@attackableID;
            Placeholder = (Nullable<Byte>)@placeholder;
        }
        ...
        public static void CopyValues(IAllianceAttackableTable source, IDictionary<String, Object> dic)
        {
            ...
            dic["@attackable_id"] = (AllianceID)source.AttackableID;
            dic["@placeholder"] = (Nullable<Byte>)source.Placeholder;
        }
        ...
        public void CopyValuesFrom(IAllianceAttackableTable source)
        {
            ...
            AttackableID = (AllianceID)source.AttackableID;
            Placeholder = (Nullable<Byte>)source.Placeholder;
        }
            ...
            switch (columnName)
            {
                ...
                case "placeholder":
                    return new ColumnMetadata("placeholder", "Unused placeholder column - please do not remove",
                                              "tinyint(3) unsigned", null, typeof(Nullable<Byte>), true, false, false);
        ...
        public void SetValue(String columnName, Object value)
        {
            switch (columnName)
            {
                ...
                case "placeholder":
                    Placeholder = (Nullable<Byte>)value;
                    break;
        ...
        /// </summary>
        public Nullable<Byte> Placeholder
        {
            get { return (Nullable<Byte>)_placeholder; }
            set { _placeholder = (Nullable<Byte>)value; }
        }
