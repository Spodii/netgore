...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterStatusEffectTable : ICharacterStatusEffectTable
    {
                                          ...
                                          StatusEffectType @statusEffect, UInt16 @timeLeftSecs)
        {
            ...
            ID = (ActiveStatusEffectID)@iD;
            Power = (UInt16)@power;
            StatusEffect = (StatusEffectType)@statusEffect;
            TimeLeftSecs = (UInt16)@timeLeftSecs;
        }
        ...
        {
            dic["@character_id"] = (CharacterID)source.CharacterID;
            dic["@id"] = (ActiveStatusEffectID)source.ID;
            dic["@power"] = (UInt16)source.Power;
            dic["@status_effect_id"] = (StatusEffectType)source.StatusEffect;
            dic["@time_left_secs"] = (UInt16)source.TimeLeftSecs;
        }
        ...
        public void CopyValuesFrom(ICharacterStatusEffectTable source)
        {
            ...
            ID = (ActiveStatusEffectID)source.ID;
            Power = (UInt16)source.Power;
            StatusEffect = (StatusEffectType)source.StatusEffect;
            TimeLeftSecs = (UInt16)source.TimeLeftSecs;
        }
        ...
        public UInt16 Power
        {
            get { return (UInt16)_power; }
            set { _power = (UInt16)value; }
        }
        ...
        {
            get { return (UInt16)_timeLeftSecs; }
            set { _timeLeftSecs = (UInt16)value; }
        }
