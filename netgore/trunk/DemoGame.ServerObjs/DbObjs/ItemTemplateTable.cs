...
namespace DemoGame.Server.DbObjs
{
    ...
    public class ItemTemplateTable : IItemTemplateTable
    {
        ...
        public ItemTemplateTable(UInt16 @agi, UInt16 @armor, UInt16 @bra, UInt16 @defence, String @description, UInt16 @dex,
                                 UInt16 @evade, UInt16 @graphic, Byte @height, UInt16 @hp, UInt16 @id, UInt16 @imm, UInt16 @int,
                                 UInt16 @maxhit, UInt16 @maxhp, UInt16 @maxmp, UInt16 @minhit, UInt16 @mp, String @name,
                                 UInt16 @perc, Byte @reqacc, Byte @reqagi, Byte @reqarmor, Byte @reqbra, Byte @reqdex,
