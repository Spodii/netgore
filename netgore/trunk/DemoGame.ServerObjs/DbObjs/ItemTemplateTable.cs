...
namespace DemoGame.Server.DbObjs
{
    ...
    public class ItemTemplateTable : IItemTemplateTable
    {
        ...
        public void CopyValuesFrom(IItemTemplateTable source)
        {
            ...
            SetReqStat(StatType.Acc, source.GetReqStat((StatType)StatType.Acc));
            SetReqStat(StatType.Agi, source.GetReqStat((StatType)StatType.Agi));
            SetReqStat(StatType.Armor, source.GetReqStat((StatType)StatType.Armor));
            SetReqStat(StatType.Bra, source.GetReqStat((StatType)StatType.Bra));
            SetReqStat(StatType.Dex, source.GetReqStat((StatType)StatType.Dex));
            SetReqStat(StatType.Evade, source.GetReqStat((StatType)StatType.Evade));
            SetReqStat(StatType.Imm, source.GetReqStat((StatType)StatType.Imm));
