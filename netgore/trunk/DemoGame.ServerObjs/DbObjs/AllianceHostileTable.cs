...
this.HostileID = (DemoGame.Server.AllianceID)@hostileID;
...
this.HostileID = (DemoGame.Server.AllianceID)source.HostileID;
...
case "hostile_id":
this.HostileID = (DemoGame.Server.AllianceID)value;
break;
