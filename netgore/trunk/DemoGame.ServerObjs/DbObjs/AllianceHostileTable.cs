...
namespace DemoGame.Server.DbObjs
{
    ...
    public class AllianceHostileTable : IAllianceHostileTable
    {
        ...
        public AllianceHostileTable(AllianceID @allianceID, AllianceID @hostileID, Nullable<Byte> @placeholder)
        {
            AllianceID = (AllianceID)@allianceID;
            HostileID = (AllianceID)@hostileID;
        ...
        public static void CopyValues(IAllianceHostileTable source, IDictionary<String, Object> dic)
        {
            ...
            dic["@hostile_id"] = (AllianceID)source.HostileID;
        ...
        public void CopyValuesFrom(IAllianceHostileTable source)
        {
            ...
            HostileID = (AllianceID)source.HostileID;
