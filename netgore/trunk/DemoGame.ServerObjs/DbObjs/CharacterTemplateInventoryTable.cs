...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTemplateInventoryTable : ICharacterTemplateInventoryTable
    {
                                               ...
                                               ItemTemplateID @itemTemplateID, Byte @max, Byte @min)
        {
            ...
            CharacterTemplateID = (CharacterTemplateID)@characterTemplateID;
            ID = (Int32)@iD;
            ItemTemplateID = (ItemTemplateID)@itemTemplateID;
            Max = (Byte)@max;
            Min = (Byte)@min;
        }
        ...
        {
            dic["@chance"] = (ItemChance)source.Chance;
            dic["@character_template_id"] = (CharacterTemplateID)source.CharacterTemplateID;
            dic["@id"] = (Int32)source.ID;
            dic["@item_template_id"] = (ItemTemplateID)source.ItemTemplateID;
            dic["@max"] = (Byte)source.Max;
            dic["@min"] = (Byte)source.Min;
        }
        ...
        {
            Chance = (ItemChance)source.Chance;
            CharacterTemplateID = (CharacterTemplateID)source.CharacterTemplateID;
            ID = (Int32)source.ID;
            ItemTemplateID = (ItemTemplateID)source.ItemTemplateID;
            Max = (Byte)source.Max;
            Min = (Byte)source.Min;
        }
