...
public CharacterTemplateEquippedTable(DemoGame.Server.ItemChance @chance, DemoGame.Server.CharacterTemplateID @characterTemplateID, System.Int32 @iD, DemoGame.Server.ItemTemplateID @itemTemplateID)
{
