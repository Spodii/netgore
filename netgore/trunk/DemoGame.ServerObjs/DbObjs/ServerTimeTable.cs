...
namespace DemoGame.Server.DbObjs
{
    ...
    public class ServerTimeTable : IServerTimeTable
    {
        ...
        /// </summary>
        static readonly String[] _dbColumnsNonKey = new string[] { "server_time" };
        ...
        {
            dic["@server_time"] = (DateTime)source.ServerTime;
        }
        ...
        {
            ServerTime = (DateTime)source.ServerTime;
        }
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            ...
            {
                case "server_time":
                    return new ColumnMetadata("server_time", "", "datetime", null, typeof(DateTime), false, false, false);
        ...
        {
            get { return (DateTime)_serverTime; }
            set { _serverTime = (DateTime)value; }
        }
