...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTable : ICharacterTable
    {
        ...
        public CharacterTable(Byte @acc, Byte @agi, Byte @armor, BodyIndex @bodyID, Byte @bra, UInt32 @cash,
                              ...
                              Int16 @hP, CharacterID @iD, Byte @imm, Byte @int, Byte @level, MapIndex @mapID, Byte @maxHit,
                              Int16 @maxHP, Int16 @maxMP, Byte @minHit, Int16 @mP, String @name, String @password, Byte @perc,
                              Byte @recov, Byte @regen, MapIndex? @respawnMap, Single @respawnX, Single @respawnY,
        ...
        public static void CopyValues(ICharacterTable source, DbParameterValues paramValues)
        {
            ...
            paramValues["@body_id"] = source.BodyID;
        ...
        public void ReadValues(IDataReader dataReader)
        {
            ...
            BodyID = (BodyIndex)dataReader.GetUInt16(i);
            ...
            CharacterTemplateID = (CharacterTemplateID?)(dataReader.IsDBNull(i) ? (ushort?)null : dataReader.GetUInt16(i));
