...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTable : ICharacterTable
    {
        ...
        public CharacterTable(Byte @acc, int? @accountId, Byte @agi, Byte @armor, BodyIndex @bodyID, Byte @bra, UInt32 @cash,
        ...
        {
            SetStat(StatType.Acc, source.GetStat((StatType)StatType.Acc));
            AccountId = source.AccountId;
            SetStat(StatType.Agi, source.GetStat((StatType)StatType.Agi));
            SetStat(StatType.Armor, source.GetStat((StatType)StatType.Armor));
            BodyID = source.BodyID;
            SetStat(StatType.Bra, source.GetStat((StatType)StatType.Bra));
            Cash = source.Cash;
            ...
            SetStat(StatType.Dex, source.GetStat((StatType)StatType.Dex));
            SetStat(StatType.Evade, source.GetStat((StatType)StatType.Evade));
            Exp = source.Exp;
            HP = source.HP;
            ID = source.ID;
            SetStat(StatType.Imm, source.GetStat((StatType)StatType.Imm));
            ...
            MP = source.MP;
            Name = source.Name;
            SetStat(StatType.Perc, source.GetStat((StatType)StatType.Perc));
            SetStat(StatType.Recov, source.GetStat((StatType)StatType.Recov));
            SetStat(StatType.Regen, source.GetStat((StatType)StatType.Regen));
            ...
            SetStat(StatType.Tact, source.GetStat((StatType)StatType.Tact));
            SetStat(StatType.WS, source.GetStat((StatType)StatType.WS));
            X = source.X;
            Y = source.Y;
        }
