...
namespace DemoGame.Server.DbObjs
{
    ...
    public class CharacterTable : ICharacterTable
    {
        ...
        {
            "acc", "agi", "armor", "body_id", "bra", "cash", "character_template_id", "chat_dialog", "defence", "dex", "evade",
            "exp", "hp", "id", "imm", "int", "level", "map_id", "maxhit", "maxhp", "maxmp", "minhit", "mp", "name", "password",
            "perc", "recov", "regen", "respawn_map", "respawn_x", "respawn_y", "statpoints", "str", "tact", "ws", "x", "y"
        };
        ...
        {
            "acc", "agi", "armor", "body_id", "bra", "cash", "character_template_id", "chat_dialog", "defence", "dex", "evade",
            "exp", "hp", "imm", "int", "level", "map_id", "maxhit", "maxhp", "maxmp", "minhit", "mp", "name", "password", "perc",
        ...
        public CharacterTable(Byte @acc, Byte @agi, Byte @armor, BodyIndex @bodyID, Byte @bra, UInt32 @cash,
                              ...
                              String @name, String @password, Byte @perc, Byte @recov, Byte @regen, MapIndex? @respawnMap,
        ...
        public static ColumnMetadata GetColumnData(String columnName)
        {
            switch (columnName)
            {
                ...
                case "password":
                    return new ColumnMetadata("password", "", "varchar(50)", "", typeof(String), false, false, false);
