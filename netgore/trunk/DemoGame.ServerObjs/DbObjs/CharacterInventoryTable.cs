...
/// </summary>
public DemoGame.InventorySlot Slot
{
get
{
return (DemoGame.InventorySlot)_slot;
}
set
{
...
public CharacterInventoryTable(DemoGame.Server.CharacterID @characterID, DemoGame.Server.ItemID @itemID, DemoGame.InventorySlot @slot)
{
this.CharacterID = (DemoGame.Server.CharacterID)@characterID;
this.ItemID = (DemoGame.Server.ItemID)@itemID;
this.Slot = (DemoGame.InventorySlot)@slot;
}
/// <summary>
/// CharacterInventoryTable constructor.
/// </summary>
...
dic["@slot"] = (DemoGame.InventorySlot)source.Slot;
}
...
this.Slot = (DemoGame.InventorySlot)source.Slot;
}
...
case "slot":
this.Slot = (DemoGame.InventorySlot)value;
break;
