    ...
    public static class CharacterQueryHelper
    {
        ...
        static CharacterQueryHelper()
        {
            ...
            NonStatDBFields =
                new string[]
                {
                    "body_id", "id", "character_template_id", "map_id", "name", "x", "y", "hp", "mp", "level", "exp", "statpoints",
                    "respawn_map", "respawn_x", "respawn_y"
                }.ToArray();
        ...
        public static SelectCharacterQueryValues ReadCharacterQueryValues(IDataReader r)
        {
            ...
            var templateID = r.GetCharacterTemplateIDNullable("character_template_id");
            string name = r.GetString("name");
            MapIndex mapIndex = r.GetMapIndex("map_id");
            float x = r.GetFloat("x");
            float y = r.GetFloat("y");
            BodyIndex body = r.GetBodyIndex("body_id");
            ...
            var respawnMap = r.GetMapIndexNullable("respawn_map");
            ...
            SelectCharacterQueryValues ret = new SelectCharacterQueryValues(id, templateID, name, mapIndex, pos, body, level, exp,
                                                                            statpoints, cash, hp, mp, respawnMap, respawnPos,
                                                                            stats);
            return ret;
        }
    }
