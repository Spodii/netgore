...
namespace NetGore.EditorTools.Docking
{
    ...
    {
        AutoHideStripSkin m_autoHideStripSkin;
        DockPaneStripSkin m_dockPaneStripSkin;
    ...
    {
        TabGradient m_TabGradient;
        DockPanelGradient m_dockStripGradient;
    ...
    {
        DockPaneStripGradient m_DocumentGradient;
        DockPaneStripToolWindowGradient m_ToolWindowGradient;
    ...
    {
        TabGradient m_activeCaptionGradient;
        TabGradient m_inactiveCaptionGradient;
    ...
    {
        TabGradient m_activeTabGradient;
        DockPanelGradient m_dockStripGradient;
        TabGradient m_inactiveTabGradient;
    ...
    {
        Color m_endColor;
        LinearGradientMode m_linearGradientMode;
        Color m_startColor;
