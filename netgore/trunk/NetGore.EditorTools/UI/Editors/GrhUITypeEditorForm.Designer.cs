...
namespace NetGore.EditorTools.UI
{
    partial class GrhUITypeEditorForm
    {
        ...
        {
            this.gtv = new NetGore.EditorTools.Grhs.GrhTreeView();
            this.SuspendLayout();
            // 
            // gtv
            // 
            ...
            this.gtv.TabIndex = 0;
            this.gtv.GrhMouseClick += new NetGore.EditorTools.Grhs.GrhTreeNodeMouseClickEvent(this.gtv_GrhMouseClick);
            this.gtv.GrhMouseDoubleClick += new NetGore.EditorTools.Grhs.GrhTreeNodeMouseClickEvent(this.gtv_GrhMouseDoubleClick);
            // 
            // GrhUITypeEditorForm
            // 
