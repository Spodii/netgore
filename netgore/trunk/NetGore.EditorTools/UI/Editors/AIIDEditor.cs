...
{
    /// <summary>
    /// A <see cref="UITypeEditor"/> for selecting the <see cref="AIID"/>.
    /// </summary>
    public class AIIDEditor : UITypeEditor
    {
