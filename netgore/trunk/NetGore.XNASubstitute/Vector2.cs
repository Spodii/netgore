...
namespace Microsoft.Xna.Framework
{
    ...
    {
        static readonly Vector2 _one = new Vector2(1f, 1f);
        static readonly Vector2 _unitX = new Vector2(1f, 0f);
        static readonly Vector2 _unitY = new Vector2(0f, 1f);
        static readonly Vector2 _zero = new Vector2(0, 0);
        public float X;
        public float Y;
